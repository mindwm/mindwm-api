...
class Clipboard implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Clipboard';
    ...
    */
     ...
     */
    public function getData(): ?\OpenAPI\Client\Model\ClipboardPayload
    {
     ...
     * @return $this
     */
    public function setData(?\OpenAPI\Client\Model\ClipboardPayload $data): static
    {
        if (is_null($data)) {
    ...
    public function setId(string $id): static
    {
        ...
        if ((mb_strlen($id) < 1)) {
            throw new InvalidArgumentException('invalid length for $id when calling Clipboard., must be bigger than or equal to 1.');
        }
    ...
    public function setSpecversion(string $specversion): static
    {
        ...
        if ((mb_strlen($specversion) < 1)) {
            throw new InvalidArgumentException('invalid length for $specversion when calling Clipboard., must be bigger than or equal to 1.');
        }
    ...
    public function setDatacontenttype(?string $datacontenttype): static
    {
        ...
        if ((mb_strlen($datacontenttype) < 1)) {
            throw new InvalidArgumentException('invalid length for $datacontenttype when calling Clipboard., must be bigger than or equal to 1.');
        }
    ...
    public function setDataschema(?string $dataschema): static
    {
        ...
        if ((mb_strlen($dataschema) < 1)) {
            throw new InvalidArgumentException('invalid length for $dataschema when calling Clipboard., must be bigger than or equal to 1.');
        }
    ...
    public function setSubject(?string $subject): static
    {
        ...
        if ((mb_strlen($subject) < 1)) {
            throw new InvalidArgumentException('invalid length for $subject when calling Clipboard., must be bigger than or equal to 1.');
        }
    ...
    public function setTime(?\DateTime $time): static
    {
        ...
        if ((mb_strlen($time) < 1)) {
            throw new InvalidArgumentException('invalid length for $time when calling Clipboard., must be bigger than or equal to 1.');
        }
