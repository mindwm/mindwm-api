...
class TmuxPaneIoDocument(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TmuxPaneIoDocument:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TmuxPaneIoDocument:
        """Create an instance of TmuxPaneIoDocument from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TmuxPaneIoDocument.parse_obj(obj)

        _obj = TmuxPaneIoDocument.parse_obj({
            "input": obj.get("input"),
