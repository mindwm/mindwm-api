...
#ifndef OAIClipboard_H
#define OAIClipboard_H
...
class OAIClipboard : public OAIObject {
public:
    OAIClipboard();
    OAIClipboard(QString json);
    ~OAIClipboard() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIClipboard)

#endif // OAIClipboard_H
