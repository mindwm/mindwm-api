...
public struct CloudEvent: Codable {
    ...
    public init(id: String, source: String, specversion: String, type: String, datacontenttype: String? = nil, dataschema: String? = nil, subject: String? = nil, time: Date? = nil, data: [String: Any]? = nil, dataBase64: String? = nil) {
        self.id = id
        self.source = source
