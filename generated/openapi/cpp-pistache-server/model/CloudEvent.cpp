...
void CloudEvent::validate() const
{
...
bool CloudEvent::validate(std::stringstream& msg) const
{
    return validate(msg, "");
}

bool CloudEvent::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "CloudEvent" : pathPrefix;
...
bool CloudEvent::operator==(const CloudEvent& rhs) const
{
    return
...
void to_json(nlohmann::json& j, const CloudEvent& o)
{
...
void from_json(const nlohmann::json& j, CloudEvent& o)
{
...
void CloudEvent::setId(std::string const& value)
{
    m_Id = value;
}
...
void CloudEvent::setSource(std::string const& value)
{
    m_Source = value;
}
...
void CloudEvent::setSpecversion(std::string const& value)
{
    m_Specversion = value;
}
...
void CloudEvent::setType(std::string const& value)
{
    m_Type = value;
}
...
void CloudEvent::setDatacontenttype(std::string const& value)
{
...
void CloudEvent::setDataschema(std::string const& value)
{
    m_Dataschema = value;
...
void CloudEvent::setSubject(std::string const& value)
{
    m_Subject = value;
    m_SubjectIsSet = true;
}
...
void CloudEvent::setTime(std::string const& value)
{
    m_Time = value;
    m_TimeIsSet = true;
}
...
void CloudEvent::setDataBase64(std::string const& value)
{
    m_Data_base64 = value;
