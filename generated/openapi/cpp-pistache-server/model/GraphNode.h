...
public:
    ...
    /// 
    /// </summary>
    org::openapitools::server::model::GraphNode_allOf_data getData() const;
    void setData(org::openapitools::server::model::GraphNode_allOf_data const& value);
    ...
    friend  void to_json(nlohmann::json& j, const GraphNode& o);
    friend  void from_json(const nlohmann::json& j, GraphNode& o);
protected:
    std::string m_Id;
    ...
    std::string m_Time;
    bool m_TimeIsSet;
    org::openapitools::server::model::GraphNode_allOf_data m_Data;
    bool m_DataIsSet;
