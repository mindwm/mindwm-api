# Mindwm API - Jetbrains API Client

## General API description

This document describes the documentation, a collection of JSON schemas and example cloudevent and payloads

* API basepath : [https://mindwmw.io/v1](https://mindwmw.io/v1)
* Version : 0.1.0

## Documentation for API Endpoints

All URIs are relative to *https://mindwmw.io/v1*, but will link to the `.http` file that contains the endpoint definition.
