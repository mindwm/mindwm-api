...
void OpenAPIGraphRelationshipAllOfData::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIGraphRelationshipAllOfData::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
