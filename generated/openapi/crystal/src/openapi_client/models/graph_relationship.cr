...
module OpenAPIClient
  class GraphRelationship
    ...
    @[JSON::Field(key: "data", type: GraphRelationshipAllOfData?, nillable: true, emit_null: false)]
    property data : GraphRelationshipAllOfData?
    ...
    def initialize(@id : String, @source : String, @specversion : String, @_type : String, @datacontenttype : String?, @dataschema : String?, @subject : String?, @time : Time?, @data : GraphRelationshipAllOfData?, @data_base64 : String?)
    end
    ...
    def valid?
      ...
      source_validator = EnumAttributeValidator.new("String", ["graph.relationship"])
    ...
    def source=(source)
      validator = EnumAttributeValidator.new("String", ["graph.relationship"])
