...
module OpenAPIClient
  ...
  class CloudEvent
    ...
    def valid?
      ...
      return false if @source.to_s.size < 1
      return false if @specversion.to_s.size < 1
      return false if @_type.to_s.size < 1
    ...
    def source=(source)
      if source.to_s.size < 1
        raise ArgumentError.new("invalid value for \"source\", the character length must be great than or equal to 1.")
      end
    ...
    def _type=(_type)
      if _type.to_s.size < 1
        raise ArgumentError.new("invalid value for \"_type\", the character length must be great than or equal to 1.")
      end
