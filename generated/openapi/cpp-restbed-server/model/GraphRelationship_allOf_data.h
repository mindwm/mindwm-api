...
public:
    ...
    GraphRelationship_allOf_data(const GraphRelationship_allOf_data& other) = default; // copy constructor
    GraphRelationship_allOf_data(GraphRelationship_allOf_data&& other) noexcept = default; // move constructor

    GraphRelationship_allOf_data& operator=(const GraphRelationship_allOf_data& other) = default; // copy assignment
    GraphRelationship_allOf_data& operator=(GraphRelationship_allOf_data&& other) noexcept = default; // move assignment
    ...
    /// 
    /// </summary>
    Neo4jCaptureDataChangeRelationshipPayload getPayload() const;
    void setPayload(Neo4jCaptureDataChangeRelationshipPayload value);
...
protected:
    ...
    Neo4jCaptureDataChangeRelationshipPayload m_Payload;
};

std::vector<GraphRelationship_allOf_data> createGraphRelationship_allOf_dataVectorFromJsonString(const std::string& json);

template<>
inline boost::property_tree::ptree toPt<GraphRelationship_allOf_data>(const GraphRelationship_allOf_data& val) {
    return val.toPropertyTree();
}

template<>
inline GraphRelationship_allOf_data fromPt<GraphRelationship_allOf_data>(const boost::property_tree::ptree& pt) {
    GraphRelationship_allOf_data ret;
