...
from app.MindwWM.models.graph_node_all_of_data import GraphNodeAllOfData  # noqa: F401,E501
...
class GraphNode(Model):
    ...
    def __init__(self, id: str=None, source: str=None, specversion: str=None, type: str=None, datacontenttype: str=None, dataschema: str=None, subject: str=None, time: datetime=None, data: GraphNodeAllOfData=None, data_base64: str=None):  # noqa: E501
        """GraphNode - a model defined in Swagger
