...
from app.MindwWM.models.clipboard_payload_context import ClipboardPayloadContext  # noqa: F401,E501
...
class ClipboardPayload(Model):
    ...
    def __init__(self, start: List[int]=None, stop: List[int]=None, data: str=None, type: str=None, context: ClipboardPayloadContext=None):  # noqa: E501
        """ClipboardPayload - a model defined in Swagger
