...
from app.MindWM.models.neo4j_capture_data_change_relationship_payload_end import Neo4jCaptureDataChangeRelationshipPayloadEnd  # noqa: F401,E501
...
class Neo4jCaptureDataChangeRelationshipPayload(Model):
    ...
    def __init__(self, after: object=None, before: str=None, end: Neo4jCaptureDataChangeRelationshipPayloadEnd=None, id: str=None, label: str=None, start: Neo4jCaptureDataChangeRelationshipPayloadEnd=None, type: str=None):  # noqa: E501
        """Neo4jCaptureDataChangeRelationshipPayload - a model defined in Swagger
