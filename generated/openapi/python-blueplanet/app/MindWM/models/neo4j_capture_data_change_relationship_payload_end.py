...
class Neo4jCaptureDataChangeRelationshipPayloadEnd(Model):
    ...
    def __init__(self, id: str=None, ids: Dict[str, object]=None, labels: List[str]=None):  # noqa: E501
        """Neo4jCaptureDataChangeRelationshipPayloadEnd - a model defined in Swagger
