...
from app.MindWM.models.clipboard_payload import ClipboardPayload  # noqa: F401,E501
...
class Clipboard(Model):
    ...
    def __init__(self, id: str=None, source: str=None, specversion: str=None, type: str=None, datacontenttype: str=None, dataschema: str=None, subject: str=None, time: datetime=None, data: ClipboardPayload=None, data_base64: str=None):  # noqa: E501
