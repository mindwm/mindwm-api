...
from app.MindWM.models.neo4j_capture_data_change_node_payload import Neo4jCaptureDataChangeNodePayload  # noqa: F401,E501
...
class GraphNodeAllOfData(Model):
    ...
    def __init__(self, headers: object=None, message_key: str=None, meta: Neo4jCaptureDataChangeMeta=None, offset: int=None, partition: int=None, source_type: str=None, timestamp: datetime=None, topic: str=None, _schema: Neo4jCaptureDataChangeSchema=None, payload: Neo4jCaptureDataChangeNodePayload=None):  # noqa: E501
        """GraphNodeAllOfData - a model defined in Swagger
