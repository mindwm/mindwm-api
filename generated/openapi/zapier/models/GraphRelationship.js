...
const GraphRelationship_allOf_data = require('../models/GraphRelationship_allOf_data');
...
module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            ...GraphRelationship_allOf_data.fields(`${keyPrefix}data`, isInput),
            {
    ...
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'data': utils.removeIfEmpty(GraphRelationship_allOf_data.mapping(bundle, `${keyPrefix}data`)),
