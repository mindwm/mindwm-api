...
module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            ...Neo4jCaptureDataChangeRelationshipPayload.fields(`${keyPrefix}payload`, isInput),
        ]
    },
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'payload': utils.removeIfEmpty(Neo4jCaptureDataChangeRelationshipPayload.mapping(bundle, `${keyPrefix}payload`)),
        }
    },
}
