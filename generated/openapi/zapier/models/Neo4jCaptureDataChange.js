...
const Neo4jCaptureDataChange_payload = require('../models/Neo4jCaptureDataChange_payload');
...
module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            ...Neo4jCaptureDataChange_payload.fields(`${keyPrefix}payload`, isInput),
        ]
    },
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'payload': utils.removeIfEmpty(Neo4jCaptureDataChange_payload.mapping(bundle, `${keyPrefix}payload`)),
        }
    },
}
