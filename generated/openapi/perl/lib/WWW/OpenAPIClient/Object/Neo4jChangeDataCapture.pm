...
#
package WWW::OpenAPIClient::Object::Neo4jChangeDataCapture;
...
__PACKAGE__->method_documentation({
    ...
    'meta' => {
        datatype => 'Neo4jChangeDataCaptureMeta',
        base_name => 'meta',
        description => '',
        format => '',
        read_only => '',
    ...
    'schema' => {
        datatype => 'Neo4jChangeDataCaptureSchema',
        base_name => 'schema',
        description => '',
        format => '',
        read_only => '',
    ...
    'payload' => {
        datatype => 'Neo4jChangeDataCapturePayload',
        base_name => 'payload',
        description => '',
        format => '',
        read_only => '',
