...
#
package WWW::OpenAPIClient::Object::GraphRelationshipAllOfData;
...
__PACKAGE__->method_documentation({
    ...
    'message_key' => {
        datatype => 'string',
        base_name => 'message_key',
        description => '',
        format => '',
        read_only => '',
            },
    'meta' => {
        datatype => 'Neo4jCaptureDataChangeMeta',
        base_name => 'meta',
        description => '',
        format => '',
        read_only => '',
    ...
    'schema' => {
        datatype => 'Neo4jCaptureDataChangeSchema',
        base_name => 'schema',
        description => '',
        format => '',
        read_only => '',
    ...
    'payload' => {
        datatype => 'Neo4jCaptureDataChangeRelationshipPayload',
        base_name => 'payload',
        description => '',
        format => '',
        read_only => '',
