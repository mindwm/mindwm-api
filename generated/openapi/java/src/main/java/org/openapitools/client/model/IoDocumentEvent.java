...
public class IoDocumentEvent {
   ...
   * @return the IoDocumentEvent instance itself
   */
   ...
   * @throws IOException if the JSON Element is invalid with respect to IoDocumentEvent
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IoDocumentEvent.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IoDocumentEvent is not found in the empty JSON string", IoDocumentEvent.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IoDocumentEvent.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IoDocumentEvent.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IoDocumentEvent' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IoDocumentEvent> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IoDocumentEvent.class));

       return (TypeAdapter<T>) new TypeAdapter<IoDocumentEvent>() {
           @Override
           public void write(JsonWriter out, IoDocumentEvent value) throws IOException {
           ...
           @Override
           public IoDocumentEvent read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             IoDocumentEvent instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of IoDocumentEvent given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IoDocumentEvent
   * @throws IOException if the JSON string is invalid with respect to IoDocumentEvent
   */
  public static IoDocumentEvent fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IoDocumentEvent.class);
  }

  /**
   * Convert an instance of IoDocumentEvent to an JSON string
   *
   * @return JSON string
   */
