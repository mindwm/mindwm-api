...
public class Neo4jChangeDataCaptureRelationshipPayload {
   ...
   * @throws IOException if the JSON Element is invalid with respect to Neo4jChangeDataCaptureRelationshipPayload
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Neo4jChangeDataCaptureRelationshipPayload.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Neo4jChangeDataCaptureRelationshipPayload is not found in the empty JSON string", Neo4jChangeDataCaptureRelationshipPayload.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Neo4jChangeDataCaptureRelationshipPayload.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Neo4jChangeDataCaptureRelationshipPayload` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Neo4jChangeDataCaptureRelationshipPayload.openapiRequiredFields) {
      ...
      Neo4jChangeDataCaptureRelationshipPayloadEnd.validateJsonElement(jsonObj.get("end"));
      ...
      Neo4jChangeDataCaptureRelationshipPayloadEnd.validateJsonElement(jsonObj.get("start"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Neo4jChangeDataCaptureRelationshipPayload.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Neo4jChangeDataCaptureRelationshipPayload' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Neo4jChangeDataCaptureRelationshipPayload> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Neo4jChangeDataCaptureRelationshipPayload.class));

       return (TypeAdapter<T>) new TypeAdapter<Neo4jChangeDataCaptureRelationshipPayload>() {
           @Override
           public void write(JsonWriter out, Neo4jChangeDataCaptureRelationshipPayload value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Neo4jChangeDataCaptureRelationshipPayload read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Neo4jChangeDataCaptureRelationshipPayload given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Neo4jChangeDataCaptureRelationshipPayload
   * @throws IOException if the JSON string is invalid with respect to Neo4jChangeDataCaptureRelationshipPayload
   */
  public static Neo4jChangeDataCaptureRelationshipPayload fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Neo4jChangeDataCaptureRelationshipPayload.class);
  }

  /**
   * Convert an instance of Neo4jChangeDataCaptureRelationshipPayload to an JSON string
   *
   * @return JSON string
   */
