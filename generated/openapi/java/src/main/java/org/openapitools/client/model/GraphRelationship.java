...
public class GraphRelationship {
   ...
   * @return the GraphRelationship instance itself
   */
   ...
   * @throws IOException if the JSON Element is invalid with respect to GraphRelationship
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GraphRelationship.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GraphRelationship is not found in the empty JSON string", GraphRelationship.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GraphRelationship.openapiRequiredFields) {
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        GraphRelationshipAllOfData.validateJsonElement(jsonObj.get("data"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GraphRelationship.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GraphRelationship' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GraphRelationship> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GraphRelationship.class));

       return (TypeAdapter<T>) new TypeAdapter<GraphRelationship>() {
           @Override
           public void write(JsonWriter out, GraphRelationship value) throws IOException {
           ...
           @Override
           public GraphRelationship read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             GraphRelationship instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of GraphRelationship given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GraphRelationship
   * @throws IOException if the JSON string is invalid with respect to GraphRelationship
   */
  public static GraphRelationship fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GraphRelationship.class);
  }

  /**
   * Convert an instance of GraphRelationship to an JSON string
   *
   * @return JSON string
   */
