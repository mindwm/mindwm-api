...
public class CloudEventData extends AbstractOpenApiSchema {
            ...
            return (TypeAdapter<T>) new TypeAdapter<CloudEventData>() {
                ...
                public CloudEventData read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        CloudEventData ret = new CloudEventData();
                    ...
                    throw new IOException(String.format("Failed deserialization for CloudEventData: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public CloudEventData(Object o) {
        super("anyOf", Boolean.TRUE);
        setActualInstance(o);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format("The JSON string is invalid for CloudEventData with anyOf schemas: BigDecimal, Boolean, String. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }
