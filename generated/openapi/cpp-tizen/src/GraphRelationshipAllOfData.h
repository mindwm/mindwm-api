...
#ifndef _GraphRelationship_allOf_data_H_
#define _GraphRelationship_allOf_data_H_
...
class GraphRelationship_allOf_data : public Object {
public:
	/*! \brief Constructor.
	 */
	GraphRelationship_allOf_data();
	GraphRelationship_allOf_data(char* str);
...
#endif /* _GraphRelationship_allOf_data_H_ */
