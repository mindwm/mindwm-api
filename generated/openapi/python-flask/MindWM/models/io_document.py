...
class IoDocument(Model):
    ...
    def __init__(self, id=None, source=None, specversion=None, type='IoDocument', datacontenttype=None, dataschema=None, subject='IoDocument', time=None, data=None, data_base64=None):  # noqa: E501
