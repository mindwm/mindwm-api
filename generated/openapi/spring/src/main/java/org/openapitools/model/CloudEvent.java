...
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", date = "2024-07-13T19:27:31.950740946Z[Etc/UTC]", comments = "Generator version: 7.7.0")
public class CloudEvent {
  ...
  private JsonNullable<@Size(min = 1) OffsetDateTime> time = JsonNullable.<OffsetDateTime>undefined();
  ...
  @JsonProperty("time")
  public JsonNullable<@Size(min = 1) OffsetDateTime> getTime() {
    return time;
  }

  public void setTime(JsonNullable<OffsetDateTime> time) {
    this.time = time;
  }
