...
GraphRelationship_allOf_data::GraphRelationship_allOf_data(std::string jsonString)
{
...
void
GraphRelationship_allOf_data::fromJson(std::string jsonObj)
{
    ...
    if(object.has_key(payloadKey))
    {
        ...
        Neo4jCaptureDataChangeRelationshipPayload* obj = &payload;
		obj->fromJson(value.dump());
...
void
GraphRelationship_allOf_data::setHeaders(Object  headers)
{
