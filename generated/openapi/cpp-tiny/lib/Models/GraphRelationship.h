...
#ifndef TINY_CPP_CLIENT_GraphRelationship_H_
#define TINY_CPP_CLIENT_GraphRelationship_H_
...
public:
	 ...
	 */
    GraphRelationship();
    GraphRelationship(std::string jsonString);


    /*! \brief Destructor.
	 */
    virtual ~GraphRelationship();
	...
	/*! \brief Get 
	 */
	GraphRelationship_allOf_data getData();

	/*! \brief Set 
	 */
	void setData(GraphRelationship_allOf_data  data);
    ...
    std::string subject{};
    std::string time{};
    GraphRelationship_allOf_data data;
    std::string data_base64{};
};
}

#endif /* TINY_CPP_CLIENT_GraphRelationship_H_ */
