...
#ifndef TINY_CPP_CLIENT_GraphRelationship_allOf_data_H_
#define TINY_CPP_CLIENT_GraphRelationship_allOf_data_H_
...
public:
    ...
    GraphRelationship_allOf_data(std::string jsonString);
	...
	/*! \brief Get 
	 */
	Neo4jCaptureDataChangeRelationshipPayload getPayload();

	/*! \brief Set 
	 */
	void setPayload(Neo4jCaptureDataChangeRelationshipPayload  payload);
...
#endif /* TINY_CPP_CLIENT_GraphRelationship_allOf_data_H_ */
