...
data class Neo4jCaptureDataChange(
    ...
    @get:JsonProperty("headers", required = true) val headers: kotlin.collections.Map<kotlin.String, kotlin.Any>,
    ...
    @field:Valid
    @Schema(example = "null", required = true, description = "")
    @get:JsonProperty("payload", required = true) val payload: Neo4jCaptureDataChangePayload
) {
