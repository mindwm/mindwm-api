...
data class GraphNode(
    ...
    @get:JsonProperty("source", required = true) val source: GraphNode.Source,
    ...
    @Schema(example = "null", required = true, description = "")
    @get:JsonProperty("type", required = true) val type: GraphNode.Type,
    ...
    @get:JsonProperty("data") val `data`: GraphNodeAllOfData? = null,
