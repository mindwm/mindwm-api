...
class GraphRelationshipAllOfData(BaseModel):
    ...
    timestamp: datetime
    topic: StrictStr
    _schema: Neo4jCaptureDataChangeSchema = Field(alias="schema")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "topic": obj.get("topic"),
            "schema": Neo4jCaptureDataChangeSchema.from_dict(obj.get("schema")) if obj.get("schema") is not None else None,
