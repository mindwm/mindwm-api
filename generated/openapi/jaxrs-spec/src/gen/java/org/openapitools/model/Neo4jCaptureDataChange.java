...
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaJAXRSSpecServerCodegen", date = "2024-07-14T10:09:16.000831326Z[Etc/UTC]", comments = "Generator version: 7.7.0")
public class Neo4jCaptureDataChange   {
  private @Valid Map<String, Object> headers = new HashMap<>();
  ...
  @NotNull public Map<String, Object> getHeaders() {
    return headers;
  }
  ...
  public Neo4jCaptureDataChange removeHeadersItem(String key) {
    if (this.headers != null) {
  ...
  @NotNull @Valid public Neo4jCaptureDataChangePayload getPayload() {
    return payload;
  }
