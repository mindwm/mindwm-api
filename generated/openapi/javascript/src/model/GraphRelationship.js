...
class GraphRelationship {
    ...
    /**
     * Constructs a <code>GraphRelationship</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GraphRelationship} obj Optional instance to populate.
     * @return {module:model/GraphRelationship} The populated <code>GraphRelationship</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GraphRelationship();
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = GraphRelationshipAllOfData.constructFromObject(data['data']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GraphRelationship</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GraphRelationship</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GraphRelationship.RequiredProperties) {
        ...
        if (data['data']) { // data not null
          GraphRelationshipAllOfData.validateJSON(data['data']);
        }
        // ensure the json data is a string
...
GraphRelationship.RequiredProperties = ["id", "source", "specversion", "type"];

/**
 * Identifies the event.
 * @member {String} id
 */
GraphRelationship.prototype['id'] = undefined;

/**
 * @member {module:model/GraphRelationship.SourceEnum} source
 */
GraphRelationship.prototype['source'] = undefined;

/**
 * The version of the CloudEvents specification which the event uses.
 * @member {String} specversion
 */
GraphRelationship.prototype['specversion'] = undefined;

/**
 * @member {module:model/GraphRelationship.TypeEnum} type
 */
GraphRelationship.prototype['type'] = undefined;

/**
 * Content type of the data value. Must adhere to RFC 2046 format.
 * @member {String} datacontenttype
 */
GraphRelationship.prototype['datacontenttype'] = undefined;

/**
 * Identifies the schema that data adheres to.
 * @member {String} dataschema
 */
GraphRelationship.prototype['dataschema'] = undefined;

/**
 * Describes the subject of the event in the context of the event producer (identified by source).
 * @member {String} subject
 */
GraphRelationship.prototype['subject'] = undefined;

/**
 * Timestamp of when the occurrence happened. Must adhere to RFC 3339.
 * @member {Date} time
 */
GraphRelationship.prototype['time'] = undefined;

/**
 * @member {module:model/GraphRelationshipAllOfData} data
 */
GraphRelationship.prototype['data'] = undefined;

/**
 * Base64 encoded event payload. Must adhere to RFC4648.
 * @member {String} data_base64
 */
GraphRelationship.prototype['data_base64'] = undefined;
