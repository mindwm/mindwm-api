...
/**
 * The GraphNodeAllOfData model module.
 * @module model/GraphNodeAllOfData
 * @version 0.1.0
 */
class GraphNodeAllOfData {
    /**
     * Constructs a new <code>GraphNodeAllOfData</code>.
     * @alias module:model/GraphNodeAllOfData
     ...
     * @param payload {module:model/Neo4jCaptureDataChangeNodePayload} 
     */
    constructor(headers, messageKey, meta, offset, partition, sourceType, timestamp, topic, schema, payload) { 
        ...
        GraphNodeAllOfData.initialize(this, headers, messageKey, meta, offset, partition, sourceType, timestamp, topic, schema, payload);
    }
    ...
    /**
     * Constructs a <code>GraphNodeAllOfData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GraphNodeAllOfData} obj Optional instance to populate.
     * @return {module:model/GraphNodeAllOfData} The populated <code>GraphNodeAllOfData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GraphNodeAllOfData();
            ...
            if (data.hasOwnProperty('payload')) {
                obj['payload'] = Neo4jCaptureDataChangeNodePayload.constructFromObject(data['payload']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GraphNodeAllOfData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GraphNodeAllOfData</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GraphNodeAllOfData.RequiredProperties) {
        ...
        if (data['payload']) { // data not null
          Neo4jCaptureDataChangeNodePayload.validateJSON(data['payload']);
        }
...
GraphNodeAllOfData.RequiredProperties = ["headers", "message_key", "meta", "offset", "partition", "source_type", "timestamp", "topic", "schema", "payload"];

/**
 * @member {Object} headers
 */
GraphNodeAllOfData.prototype['headers'] = undefined;

/**
 * @member {String} message_key
 */
GraphNodeAllOfData.prototype['message_key'] = undefined;

/**
 * @member {module:model/Neo4jCaptureDataChangeMeta} meta
 */
GraphNodeAllOfData.prototype['meta'] = undefined;

/**
 * @member {Number} offset
 */
GraphNodeAllOfData.prototype['offset'] = undefined;

/**
 * @member {Number} partition
 */
GraphNodeAllOfData.prototype['partition'] = undefined;

/**
 * @member {String} source_type
 */
GraphNodeAllOfData.prototype['source_type'] = undefined;

/**
 * @member {Date} timestamp
 */
GraphNodeAllOfData.prototype['timestamp'] = undefined;

/**
 * @member {String} topic
 */
GraphNodeAllOfData.prototype['topic'] = undefined;

/**
 * @member {module:model/Neo4jCaptureDataChangeSchema} schema
 */
GraphNodeAllOfData.prototype['schema'] = undefined;

/**
 * @member {module:model/Neo4jCaptureDataChangeNodePayload} payload
 */
GraphNodeAllOfData.prototype['payload'] = undefined;
...
export default GraphNodeAllOfData;
