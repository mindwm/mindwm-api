...
class GraphNode {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = GraphNodeAllOfData.constructFromObject(data['data']);
            }
    ...
    static validateJSON(data) {
        ...
        for (const property of GraphNode.RequiredProperties) {
        ...
        if (data['data']) { // data not null
          GraphNodeAllOfData.validateJSON(data['data']);
        }
        // ensure the json data is a string
...
GraphNode.RequiredProperties = ["id", "source", "specversion", "type"];

/**
 * Identifies the event.
 * @member {String} id
 */
GraphNode.prototype['id'] = undefined;

/**
 * @member {module:model/GraphNode.SourceEnum} source
 */
GraphNode.prototype['source'] = undefined;

/**
 * The version of the CloudEvents specification which the event uses.
 * @member {String} specversion
 */
GraphNode.prototype['specversion'] = undefined;

/**
 * @member {module:model/GraphNode.TypeEnum} type
 */
GraphNode.prototype['type'] = undefined;

/**
 * Content type of the data value. Must adhere to RFC 2046 format.
 * @member {String} datacontenttype
 */
GraphNode.prototype['datacontenttype'] = undefined;

/**
 * Identifies the schema that data adheres to.
 * @member {String} dataschema
 */
GraphNode.prototype['dataschema'] = undefined;

/**
 * Describes the subject of the event in the context of the event producer (identified by source).
 * @member {String} subject
 */
GraphNode.prototype['subject'] = undefined;

/**
 * Timestamp of when the occurrence happened. Must adhere to RFC 3339.
 * @member {Date} time
 */
GraphNode.prototype['time'] = undefined;

/**
 * @member {module:model/GraphNodeAllOfData} data
 */
GraphNode.prototype['data'] = undefined;

/**
 * Base64 encoded event payload. Must adhere to RFC4648.
 * @member {String} data_base64
 */
GraphNode.prototype['data_base64'] = undefined;
