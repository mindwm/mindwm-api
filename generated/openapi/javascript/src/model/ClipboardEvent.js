...
class ClipboardEvent {
    ...
    static initialize(obj, id, source, specversion, type) { 
        ...
        obj['type'] = type || 'Clipboard';
    }

    /**
     * Constructs a <code>ClipboardEvent</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ClipboardEvent} obj Optional instance to populate.
     * @return {module:model/ClipboardEvent} The populated <code>ClipboardEvent</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ClipboardEvent();
    ...
    /**
     * Validates the JSON data with respect to <code>ClipboardEvent</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ClipboardEvent</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ClipboardEvent.RequiredProperties) {
...
ClipboardEvent.RequiredProperties = ["id", "source", "specversion", "type"];

/**
 * Identifies the event.
 * @member {String} id
 */
ClipboardEvent.prototype['id'] = undefined;

/**
 * @member {String} source
 */
ClipboardEvent.prototype['source'] = undefined;

/**
 * The version of the CloudEvents specification which the event uses.
 * @member {String} specversion
 */
ClipboardEvent.prototype['specversion'] = undefined;

/**
 * @member {String} type
 * @default 'Clipboard'
 */
ClipboardEvent.prototype['type'] = 'Clipboard';

/**
 * Content type of the data value. Must adhere to RFC 2046 format.
 * @member {String} datacontenttype
 */
ClipboardEvent.prototype['datacontenttype'] = undefined;

/**
 * Identifies the schema that data adheres to.
 * @member {String} dataschema
 */
ClipboardEvent.prototype['dataschema'] = undefined;

/**
 * @member {String} subject
 * @default 'Clipboard'
 */
ClipboardEvent.prototype['subject'] = 'Clipboard';
