...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MindwmApi.GraphRelationshipAllOfData();
  });
  ...
  describe('GraphRelationshipAllOfData', function() {
    it('should create an instance of GraphRelationshipAllOfData', function() {
      // uncomment below and update the code to test GraphRelationshipAllOfData
      //var instance = new MindwmApi.GraphRelationshipAllOfData();
      //expect(instance).to.be.a(MindwmApi.GraphRelationshipAllOfData);
    });
