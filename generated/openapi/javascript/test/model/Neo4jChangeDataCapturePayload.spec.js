...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MindwmApi.Neo4jChangeDataCapturePayload();
  });
  ...
  describe('Neo4jChangeDataCapturePayload', function() {
    it('should create an instance of Neo4jChangeDataCapturePayload', function() {
      // uncomment below and update the code to test Neo4jChangeDataCapturePayload
      //var instance = new MindwmApi.Neo4jChangeDataCapturePayload();
      //expect(instance).to.be.a(MindwmApi.Neo4jChangeDataCapturePayload);
    });
