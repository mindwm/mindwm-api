...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MindwmApi.GraphNodeAllOfData();
  });
  ...
  describe('GraphNodeAllOfData', function() {
    it('should create an instance of GraphNodeAllOfData', function() {
      // uncomment below and update the code to test GraphNodeAllOfData
      //var instance = new MindwmApi.GraphNodeAllOfData();
      //expect(instance).to.be.a(MindwmApi.GraphNodeAllOfData);
    });
