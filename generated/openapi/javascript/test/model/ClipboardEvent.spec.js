...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MindwmApi.ClipboardEvent();
  });
  ...
  describe('ClipboardEvent', function() {
    it('should create an instance of ClipboardEvent', function() {
      // uncomment below and update the code to test ClipboardEvent
      //var instance = new MindwmApi.ClipboardEvent();
      //expect(instance).to.be.a(MindwmApi.ClipboardEvent);
    });
