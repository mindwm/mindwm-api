...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MindwmApi.Neo4jCaptureDataChangeMeta();
  });
  ...
  describe('Neo4jCaptureDataChangeMeta', function() {
    it('should create an instance of Neo4jCaptureDataChangeMeta', function() {
      // uncomment below and update the code to test Neo4jCaptureDataChangeMeta
      //var instance = new MindwmApi.Neo4jCaptureDataChangeMeta();
      //expect(instance).to.be.a(MindwmApi.Neo4jCaptureDataChangeMeta);
    });
