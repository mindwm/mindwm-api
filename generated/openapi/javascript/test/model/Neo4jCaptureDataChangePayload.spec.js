...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MindwmApi.Neo4jCaptureDataChangePayload();
  });
  ...
  describe('Neo4jCaptureDataChangePayload', function() {
    it('should create an instance of Neo4jCaptureDataChangePayload', function() {
      // uncomment below and update the code to test Neo4jCaptureDataChangePayload
      //var instance = new MindwmApi.Neo4jCaptureDataChangePayload();
      //expect(instance).to.be.a(MindwmApi.Neo4jCaptureDataChangePayload);
    });
