...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MindwmApi.IoDocumentEvent();
  });
  ...
  describe('IoDocumentEvent', function() {
    it('should create an instance of IoDocumentEvent', function() {
      // uncomment below and update the code to test IoDocumentEvent
      //var instance = new MindwmApi.IoDocumentEvent();
      //expect(instance).to.be.a(MindwmApi.IoDocumentEvent);
    });
