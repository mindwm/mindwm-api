...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MindwmApi.TouchEvent();
  });
  ...
  describe('TouchEvent', function() {
    it('should create an instance of TouchEvent', function() {
      // uncomment below and update the code to test TouchEvent
      //var instance = new MindwmApi.TouchEvent();
      //expect(instance).to.be.a(MindwmApi.TouchEvent);
    });
