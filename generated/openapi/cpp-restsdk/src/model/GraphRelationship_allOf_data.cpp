...
void GraphRelationship_allOf_data::validate()
{
    // TODO: implement validation
}

web::json::value GraphRelationship_allOf_data::toJson() const
{
...
bool GraphRelationship_allOf_data::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("payload"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<Neo4jCaptureDataChangeRelationshipPayload> refVal_setPayload;
...
void GraphRelationship_allOf_data::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GraphRelationship_allOf_data::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
void GraphRelationship_allOf_data::setHeaders(const std::shared_ptr<Object>& value)
{
    m_Headers = value;
    m_HeadersIsSet = true;
}

bool GraphRelationship_allOf_data::headersIsSet() const
{
    return m_HeadersIsSet;
}

void GraphRelationship_allOf_data::unsetHeaders()
{
    m_HeadersIsSet = false;
}
utility::string_t GraphRelationship_allOf_data::getMessageKey() const
{
    return m_Message_key;
}

void GraphRelationship_allOf_data::setMessageKey(const utility::string_t& value)
{
    m_Message_key = value;
    m_Message_keyIsSet = true;
}

bool GraphRelationship_allOf_data::messageKeyIsSet() const
{
    return m_Message_keyIsSet;
}

void GraphRelationship_allOf_data::unsetMessage_key()
{
    m_Message_keyIsSet = false;
}
...
void GraphRelationship_allOf_data::setMeta(const std::shared_ptr<Neo4jCaptureDataChange_meta>& value)
{
    m_Meta = value;
    m_MetaIsSet = true;
}

bool GraphRelationship_allOf_data::metaIsSet() const
{
    return m_MetaIsSet;
}

void GraphRelationship_allOf_data::unsetMeta()
{
    m_MetaIsSet = false;
}
...
bool GraphRelationship_allOf_data::offsetIsSet() const
{
    return m_OffsetIsSet;
}

void GraphRelationship_allOf_data::unsetOffset()
{
    m_OffsetIsSet = false;
}
...
bool GraphRelationship_allOf_data::partitionIsSet() const
{
    return m_PartitionIsSet;
}

void GraphRelationship_allOf_data::unsetPartition()
{
    m_PartitionIsSet = false;
}
utility::string_t GraphRelationship_allOf_data::getSourceType() const
{
    return m_Source_type;
}

void GraphRelationship_allOf_data::setSourceType(const utility::string_t& value)
{
    m_Source_type = value;
    m_Source_typeIsSet = true;
}

bool GraphRelationship_allOf_data::sourceTypeIsSet() const
{
    return m_Source_typeIsSet;
}

void GraphRelationship_allOf_data::unsetSource_type()
{
    m_Source_typeIsSet = false;
}
utility::datetime GraphRelationship_allOf_data::getTimestamp() const
{
    return m_Timestamp;
}

void GraphRelationship_allOf_data::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool GraphRelationship_allOf_data::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void GraphRelationship_allOf_data::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
utility::string_t GraphRelationship_allOf_data::getTopic() const
{
    return m_Topic;
}

void GraphRelationship_allOf_data::setTopic(const utility::string_t& value)
{
    m_Topic = value;
    m_TopicIsSet = true;
}

bool GraphRelationship_allOf_data::topicIsSet() const
{
    return m_TopicIsSet;
}

void GraphRelationship_allOf_data::unsetTopic()
{
    m_TopicIsSet = false;
}
...
void GraphRelationship_allOf_data::setSchema(const std::shared_ptr<Neo4jCaptureDataChange_schema>& value)
{
    m_Schema = value;
    m_SchemaIsSet = true;
}

bool GraphRelationship_allOf_data::schemaIsSet() const
{
    return m_SchemaIsSet;
}

void GraphRelationship_allOf_data::unsetSchema()
{
    m_SchemaIsSet = false;
}
...
void GraphRelationship_allOf_data::setPayload(const std::shared_ptr<Neo4jCaptureDataChangeRelationshipPayload>& value)
{
    m_Payload = value;
    m_PayloadIsSet = true;
}

bool GraphRelationship_allOf_data::payloadIsSet() const
{
    return m_PayloadIsSet;
}

void GraphRelationship_allOf_data::unsetPayload()
{
    m_PayloadIsSet = false;
}
}
