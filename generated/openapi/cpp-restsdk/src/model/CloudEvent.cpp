...
#include "MindwWM/model/CloudEvent.h"
...
void CloudEvent::validate()
{
    // TODO: implement validation
}

web::json::value CloudEvent::toJson() const
{
...
bool CloudEvent::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CloudEvent::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CloudEvent::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t CloudEvent::getId() const
{
    return m_Id;
}

void CloudEvent::setId(const utility::string_t& value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool CloudEvent::idIsSet() const
{
    return m_IdIsSet;
}

void CloudEvent::unsetId()
{
    m_IdIsSet = false;
}
utility::string_t CloudEvent::getSource() const
{
    return m_Source;
}

void CloudEvent::setSource(const utility::string_t& value)
{
    m_Source = value;
    m_SourceIsSet = true;
}

bool CloudEvent::sourceIsSet() const
{
    return m_SourceIsSet;
}

void CloudEvent::unsetSource()
{
    m_SourceIsSet = false;
}
utility::string_t CloudEvent::getSpecversion() const
{
    return m_Specversion;
}

void CloudEvent::setSpecversion(const utility::string_t& value)
{
    m_Specversion = value;
    m_SpecversionIsSet = true;
}

bool CloudEvent::specversionIsSet() const
{
    return m_SpecversionIsSet;
}

void CloudEvent::unsetSpecversion()
{
    m_SpecversionIsSet = false;
}
utility::string_t CloudEvent::getType() const
{
    return m_Type;
}

void CloudEvent::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool CloudEvent::typeIsSet() const
{
    return m_TypeIsSet;
}

void CloudEvent::unsetType()
{
    m_TypeIsSet = false;
}
utility::string_t CloudEvent::getDatacontenttype() const
{
    return m_Datacontenttype;
}

void CloudEvent::setDatacontenttype(const utility::string_t& value)
{
    m_Datacontenttype = value;
    m_DatacontenttypeIsSet = true;
}

bool CloudEvent::datacontenttypeIsSet() const
{
    return m_DatacontenttypeIsSet;
}

void CloudEvent::unsetDatacontenttype()
{
    m_DatacontenttypeIsSet = false;
}
utility::string_t CloudEvent::getDataschema() const
{
    return m_Dataschema;
}

void CloudEvent::setDataschema(const utility::string_t& value)
{
    m_Dataschema = value;
    m_DataschemaIsSet = true;
}

bool CloudEvent::dataschemaIsSet() const
{
    return m_DataschemaIsSet;
}

void CloudEvent::unsetDataschema()
{
    m_DataschemaIsSet = false;
}
utility::string_t CloudEvent::getSubject() const
{
    return m_Subject;
}

void CloudEvent::setSubject(const utility::string_t& value)
{
    m_Subject = value;
    m_SubjectIsSet = true;
}

bool CloudEvent::subjectIsSet() const
{
    return m_SubjectIsSet;
}

void CloudEvent::unsetSubject()
{
    m_SubjectIsSet = false;
}
utility::datetime CloudEvent::getTime() const
{
    return m_Time;
}

void CloudEvent::setTime(const utility::datetime& value)
{
    m_Time = value;
    m_TimeIsSet = true;
}

bool CloudEvent::timeIsSet() const
{
    return m_TimeIsSet;
}

void CloudEvent::unsetTime()
{
    m_TimeIsSet = false;
}
...
bool CloudEvent::dataIsSet() const
{
    return m_DataIsSet;
}

void CloudEvent::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t CloudEvent::getDataBase64() const
{
    return m_Data_base64;
}

void CloudEvent::setDataBase64(const utility::string_t& value)
{
    m_Data_base64 = value;
    m_Data_base64IsSet = true;
}

bool CloudEvent::dataBase64IsSet() const
{
    return m_Data_base64IsSet;
}

void CloudEvent::unsetData_base64()
{
    m_Data_base64IsSet = false;
}
}
