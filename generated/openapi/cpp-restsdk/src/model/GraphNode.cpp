...
#include "MindwWM/model/GraphNode.h"
...
bool GraphNode::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(U("data"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<GraphNode_allOf_data> refVal_setData;
...
utility::string_t GraphNode::getSource() const
{
    return m_Source;
}

void GraphNode::setSource(const utility::string_t& value)
{
    m_Source = value;
    m_SourceIsSet = true;
}

bool GraphNode::sourceIsSet() const
{
    return m_SourceIsSet;
}

void GraphNode::unsetSource()
{
    m_SourceIsSet = false;
}
utility::string_t GraphNode::getSpecversion() const
{
    return m_Specversion;
}

void GraphNode::setSpecversion(const utility::string_t& value)
{
    m_Specversion = value;
    m_SpecversionIsSet = true;
}

bool GraphNode::specversionIsSet() const
{
    return m_SpecversionIsSet;
}

void GraphNode::unsetSpecversion()
{
    m_SpecversionIsSet = false;
}
...
utility::string_t GraphNode::getDatacontenttype() const
{
    return m_Datacontenttype;
}

void GraphNode::setDatacontenttype(const utility::string_t& value)
{
...
utility::string_t GraphNode::getDataschema() const
{
    return m_Dataschema;
}

void GraphNode::setDataschema(const utility::string_t& value)
{
    m_Dataschema = value;
...
utility::string_t GraphNode::getSubject() const
{
    return m_Subject;
}

void GraphNode::setSubject(const utility::string_t& value)
{
    m_Subject = value;
    m_SubjectIsSet = true;
}
...
utility::datetime GraphNode::getTime() const
{
    return m_Time;
}

void GraphNode::setTime(const utility::datetime& value)
{
    m_Time = value;
    m_TimeIsSet = true;
}
...
void GraphNode::setData(const std::shared_ptr<GraphNode_allOf_data>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}
...
utility::string_t GraphNode::getDataBase64() const
{
    return m_Data_base64;
}

void GraphNode::setDataBase64(const utility::string_t& value)
{
    m_Data_base64 = value;
