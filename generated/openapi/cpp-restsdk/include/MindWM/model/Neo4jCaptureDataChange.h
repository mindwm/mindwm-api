...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_Neo4jCaptureDataChange_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_Neo4jCaptureDataChange_H_
...
#include "MindWM/model/Neo4jCaptureDataChange_payload.h"
...
public:
    ...
    /// 
    /// </summary>
    std::map<utility::string_t, std::shared_ptr<AnyType>>& getHeaders();
    bool headersIsSet() const;
    void unsetHeaders();

    void setHeaders(const std::map<utility::string_t, std::shared_ptr<AnyType>>& value);
    ...
    void setPayload(const std::shared_ptr<Neo4jCaptureDataChange_payload>& value);


protected:
    std::map<utility::string_t, std::shared_ptr<AnyType>> m_Headers;
    bool m_HeadersIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_Neo4jCaptureDataChange_H_ */
