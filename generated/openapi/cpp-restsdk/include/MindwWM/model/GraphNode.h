...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_GraphNode_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_GraphNode_H_
...
public:
    ...
    /// 
    /// </summary>
    std::shared_ptr<GraphNode_allOf_data> getData() const;
    bool dataIsSet() const;
    void unsetData();

    void setData(const std::shared_ptr<GraphNode_allOf_data>& value);
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_GraphNode_H_ */
