...
import org.openapitools.models.GraphNodeAllOfData
...
object GraphNode {
    /**
     * Creates the codec for converting GraphNode from and to JSON.
     */
    implicit val decoder: Decoder[GraphNode] = deriveDecoder
    implicit val encoder: ObjectEncoder[GraphNode] = deriveEncoder
}
