...
import org.openapitools.models.ClipboardPayload
 ...
 */
case class Clipboard(_type: Option[String],
...
object Clipboard {
    /**
     * Creates the codec for converting Clipboard from and to JSON.
     */
    implicit val decoder: Decoder[Clipboard] = deriveDecoder
    implicit val encoder: ObjectEncoder[Clipboard] = deriveEncoder
}
