...
class NEO4J_CAPTURE_DATA_CHANGE
...
feature --Access
    ...
    headers: detachable STRING_TABLE [ANY]
    ...
    payload: detachable NEO4J_CAPTURE_DATA_CHANGE_PAYLOAD
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass NEO4J_CAPTURE_DATA_CHANGE%N")
        if attached headers as l_headers then
          Result.append ("%Nheaders:")
          across l_headers as ic loop
            Result.append ("%N")
            Result.append ("key:")
