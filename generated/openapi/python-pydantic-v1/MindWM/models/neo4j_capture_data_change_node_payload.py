...
class Neo4jCaptureDataChangeNodePayload(BaseModel):
    ...
    """
    after: Neo4jCaptureDataChangeNodePayloadAfter = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Neo4jCaptureDataChangeNodePayload:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Neo4jCaptureDataChangeNodePayload:
        """Create an instance of Neo4jCaptureDataChangeNodePayload from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Neo4jCaptureDataChangeNodePayload.parse_obj(obj)

        _obj = Neo4jCaptureDataChangeNodePayload.parse_obj({
            "after": Neo4jCaptureDataChangeNodePayloadAfter.from_dict(obj.get("after")) if obj.get("after") is not None else None,
