...
class GraphNodeAllOfData(BaseModel):
    ...
    payload: Neo4jCaptureDataChangeNodePayload = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GraphNodeAllOfData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GraphNodeAllOfData:
        """Create an instance of GraphNodeAllOfData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GraphNodeAllOfData.parse_obj(obj)

        _obj = GraphNodeAllOfData.parse_obj({
            ...
            "payload": Neo4jCaptureDataChangeNodePayload.from_dict(obj.get("payload")) if obj.get("payload") is not None else None
        })
        return _obj
