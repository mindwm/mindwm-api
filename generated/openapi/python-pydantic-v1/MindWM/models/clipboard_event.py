...
class ClipboardEvent(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClipboardEvent:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClipboardEvent:
        """Create an instance of ClipboardEvent from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClipboardEvent.parse_obj(obj)

        _obj = ClipboardEvent.parse_obj({
            "id": obj.get("id"),
            ...
            "time": obj.get("time"),
            "data": Clipboard.from_dict(obj.get("data")) if obj.get("data") is not None else None,
