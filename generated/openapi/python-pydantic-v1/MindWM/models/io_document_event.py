...
class IoDocumentEvent(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IoDocumentEvent:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IoDocumentEvent:
        """Create an instance of IoDocumentEvent from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IoDocumentEvent.parse_obj(obj)

        _obj = IoDocumentEvent.parse_obj({
            "id": obj.get("id"),
