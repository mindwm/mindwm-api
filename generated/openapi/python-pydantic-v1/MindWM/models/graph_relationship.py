...
class GraphRelationship(BaseModel):
    ...
    data: Optional[GraphRelationshipAllOfData] = None
    ...
    def source_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('graph.relationship'):
            raise ValueError("must be one of enum values ('graph.relationship')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GraphRelationship:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GraphRelationship:
        """Create an instance of GraphRelationship from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GraphRelationship.parse_obj(obj)

        _obj = GraphRelationship.parse_obj({
            "id": obj.get("id"),
            ...
            "time": obj.get("time"),
            "data": GraphRelationshipAllOfData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
