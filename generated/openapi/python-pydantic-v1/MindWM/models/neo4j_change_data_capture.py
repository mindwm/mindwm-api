...
class Neo4jChangeDataCapture(BaseModel):
    ...
    meta: Neo4jChangeDataCaptureMeta = Field(...)
    offset: StrictInt = Field(...)
    partition: StrictInt = Field(...)
    source_type: StrictStr = Field(...)
    timestamp: datetime = Field(...)
    topic: StrictStr = Field(...)
    var_schema: Neo4jChangeDataCaptureSchema = Field(default=..., alias="schema")
    payload: Neo4jChangeDataCapturePayload = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Neo4jChangeDataCapture:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Neo4jChangeDataCapture:
        """Create an instance of Neo4jChangeDataCapture from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Neo4jChangeDataCapture.parse_obj(obj)

        _obj = Neo4jChangeDataCapture.parse_obj({
            "headers": obj.get("headers"),
            "message_key": obj.get("message_key"),
            "meta": Neo4jChangeDataCaptureMeta.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
            "offset": obj.get("offset"),
            "partition": obj.get("partition"),
            "source_type": obj.get("source_type"),
            "timestamp": obj.get("timestamp"),
            "topic": obj.get("topic"),
            "var_schema": Neo4jChangeDataCaptureSchema.from_dict(obj.get("schema")) if obj.get("schema") is not None else None,
            "payload": Neo4jChangeDataCapturePayload.from_dict(obj.get("payload")) if obj.get("payload") is not None else None
        })
        return _obj
