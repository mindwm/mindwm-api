...
class Neo4jChangeDataCaptureMeta(BaseModel):
    ...
    source: Neo4jChangeDataCaptureMetaSource = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Neo4jChangeDataCaptureMeta:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Neo4jChangeDataCaptureMeta:
        """Create an instance of Neo4jChangeDataCaptureMeta from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Neo4jChangeDataCaptureMeta.parse_obj(obj)

        _obj = Neo4jChangeDataCaptureMeta.parse_obj({
            "operation": obj.get("operation"),
            "source": Neo4jChangeDataCaptureMetaSource.from_dict(obj.get("source")) if obj.get("source") is not None else None,
