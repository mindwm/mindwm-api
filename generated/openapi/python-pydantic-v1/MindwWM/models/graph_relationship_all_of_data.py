...
class GraphRelationshipAllOfData(BaseModel):
    """
    ...
    payload: Neo4jCaptureDataChangeRelationshipPayload = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GraphRelationshipAllOfData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GraphRelationshipAllOfData:
        """Create an instance of GraphRelationshipAllOfData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GraphRelationshipAllOfData.parse_obj(obj)

        _obj = GraphRelationshipAllOfData.parse_obj({
            ...
            "payload": Neo4jCaptureDataChangeRelationshipPayload.from_dict(obj.get("payload")) if obj.get("payload") is not None else None
        })
        return _obj
