...
class Neo4jCaptureDataChangeRelationshipPayload(BaseModel):
    ...
    end: Neo4jCaptureDataChangeRelationshipPayloadEnd = Field(...)
    id: StrictStr = Field(...)
    label: StrictStr = Field(...)
    start: Neo4jCaptureDataChangeRelationshipPayloadEnd = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Neo4jCaptureDataChangeRelationshipPayload:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Neo4jCaptureDataChangeRelationshipPayload:
        """Create an instance of Neo4jCaptureDataChangeRelationshipPayload from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Neo4jCaptureDataChangeRelationshipPayload.parse_obj(obj)

        _obj = Neo4jCaptureDataChangeRelationshipPayload.parse_obj({
            "after": obj.get("after"),
