...
class CloudEvent 
{
    ...
    * Sets source.
    *
    * @param string|null $source  Identifies the context in which an event happened.
    *
    * @return $this
    */
    ...
    * Sets type.
    *
    * @param string|null $type  Describes the type of event related to the originating occurrence.
    *
    * @return $this
    */
