...
class GraphNode 
{
    ...
    */
     ...
     * @SerializedName("data")
     * @Type("OpenAPI\Server\Model\GraphNodeAllOfData")
    */
    #[Assert\Type("OpenAPI\Server\Model\GraphNodeAllOfData")]
    protected ?GraphNodeAllOfData $data = null;
    ...
    */
     ...
     * Gets data.
     *
     * @return GraphNodeAllOfData|null
     */
    public function getData(): ?GraphNodeAllOfData
    {
        return $this->data;
    }
    ...
    * @return $this
    */
    public function setData(?GraphNodeAllOfData $data = null): self
    {
        $this->data = $data;
