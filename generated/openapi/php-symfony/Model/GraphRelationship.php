...
class GraphRelationship 
{
    ...
    */
    #[Assert\NotNull]
    #[Assert\Choice(["graph.relationship"])]
    #[Assert\Type("string")]
    ...
    */
    #[Assert\NotNull]
    #[Assert\Choice(["created", "updated", "deleted"])]
    #[Assert\Type("string")]
    ...
    */
     ...
     * @SerializedName("data")
     * @Type("OpenAPI\Server\Model\GraphRelationshipAllOfData")
    */
    #[Assert\Type("OpenAPI\Server\Model\GraphRelationshipAllOfData")]
    protected ?GraphRelationshipAllOfData $data = null;
    ...
    */
     ...
     * Gets data.
     *
     * @return GraphRelationshipAllOfData|null
     */
    public function getData(): ?GraphRelationshipAllOfData
    {
        return $this->data;
    }
    ...
    * @return $this
    */
    public function setData(?GraphRelationshipAllOfData $data = null): self
    {
        $this->data = $data;
