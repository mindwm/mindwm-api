...
use OpenAPI\Server\Model\CloudEvent;
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\CloudEvent
 */
class CloudEventTest extends TestCase
{
    protected CloudEvent|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(CloudEvent::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(CloudEvent::class));
        $this->assertInstanceOf(CloudEvent::class, $this->object);
    }
