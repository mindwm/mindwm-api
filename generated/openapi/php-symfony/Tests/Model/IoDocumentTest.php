...
use OpenAPI\Server\Model\IoDocument;
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\IoDocument
 */
class IoDocumentTest extends TestCase
{
    protected IoDocument|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(IoDocument::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(IoDocument::class));
        $this->assertInstanceOf(IoDocument::class, $this->object);
    }
