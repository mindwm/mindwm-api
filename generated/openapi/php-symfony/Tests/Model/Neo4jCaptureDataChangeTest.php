...
use OpenAPI\Server\Model\Neo4jCaptureDataChange;
 ...
 *
 * @category    Class
 * @description Neo4jCaptureDataChange
 * @package     OpenAPI\Server\Tests\Model
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\Neo4jCaptureDataChange
 */
class Neo4jCaptureDataChangeTest extends TestCase
{
    protected Neo4jCaptureDataChange|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(Neo4jCaptureDataChange::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(Neo4jCaptureDataChange::class));
        $this->assertInstanceOf(Neo4jCaptureDataChange::class, $this->object);
    }
