...
use OpenAPI\Server\Model\Clipboard;
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\Clipboard
 */
class ClipboardTest extends TestCase
{
    protected Clipboard|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(Clipboard::class)->getMockForAbstractClass();
    }
    ...
    public function testTestClassExists(): void
    {
        ...
        $this->assertInstanceOf(Clipboard::class, $this->object);
    }
