...
neo4j_change_data_capture_schema_t *neo4j_change_data_capture_schema_create(
    ...
    neo4j_change_data_capture_schema_t *neo4j_change_data_capture_schema_local_var = malloc(sizeof(neo4j_change_data_capture_schema_t));
    if (!neo4j_change_data_capture_schema_local_var) {
        return NULL;
    }
    neo4j_change_data_capture_schema_local_var->constraints = constraints;
    neo4j_change_data_capture_schema_local_var->properties = properties;

    return neo4j_change_data_capture_schema_local_var;
}


void neo4j_change_data_capture_schema_free(neo4j_change_data_capture_schema_t *neo4j_change_data_capture_schema) {
    if(NULL == neo4j_change_data_capture_schema){
        return ;
    }
    listEntry_t *listEntry;
    if (neo4j_change_data_capture_schema->constraints) {
        list_ForEach(listEntry, neo4j_change_data_capture_schema->constraints) {
            keyValuePair_t *localKeyValue = (keyValuePair_t*) listEntry->data;
            free (localKeyValue->key);
            free (localKeyValue->value);
            keyValuePair_free(localKeyValue);
        }
        list_freeList(neo4j_change_data_capture_schema->constraints);
        neo4j_change_data_capture_schema->constraints = NULL;
    }
    if (neo4j_change_data_capture_schema->properties) {
        list_ForEach(listEntry, neo4j_change_data_capture_schema->properties) {
            keyValuePair_t *localKeyValue = (keyValuePair_t*) listEntry->data;
            free (localKeyValue->key);
            free (localKeyValue->value);
            keyValuePair_free(localKeyValue);
        }
        list_freeList(neo4j_change_data_capture_schema->properties);
        neo4j_change_data_capture_schema->properties = NULL;
    }
    free(neo4j_change_data_capture_schema);
}
...
cJSON *neo4j_change_data_capture_schema_convertToJSON(neo4j_change_data_capture_schema_t *neo4j_change_data_capture_schema) {
    ...
    // neo4j_change_data_capture_schema->constraints
    if(neo4j_change_data_capture_schema->constraints) {
    ...
    if (neo4j_change_data_capture_schema->constraints) {
    list_ForEach(constraintsListEntry, neo4j_change_data_capture_schema->constraints) {
    ...
    // neo4j_change_data_capture_schema->properties
    if(neo4j_change_data_capture_schema->properties) {
    ...
    if (neo4j_change_data_capture_schema->properties) {
    list_ForEach(propertiesListEntry, neo4j_change_data_capture_schema->properties) {
...
neo4j_change_data_capture_schema_t *neo4j_change_data_capture_schema_parseFromJSON(cJSON *neo4j_change_data_capture_schemaJSON){
    ...
    neo4j_change_data_capture_schema_t *neo4j_change_data_capture_schema_local_var = NULL;

    // define the local map for neo4j_change_data_capture_schema->constraints
    list_t *constraintsList = NULL;

    // define the local map for neo4j_change_data_capture_schema->properties
    list_t *propertiesList = NULL;

    // neo4j_change_data_capture_schema->constraints
    cJSON *constraints = cJSON_GetObjectItemCaseSensitive(neo4j_change_data_capture_schemaJSON, "constraints");
    if (constraints) { 
    ...
    // neo4j_change_data_capture_schema->properties
    cJSON *properties = cJSON_GetObjectItemCaseSensitive(neo4j_change_data_capture_schemaJSON, "properties");
    if (properties) { 
    ...
    neo4j_change_data_capture_schema_local_var = neo4j_change_data_capture_schema_create (
