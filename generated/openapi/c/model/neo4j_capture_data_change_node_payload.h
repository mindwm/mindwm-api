/*
 * neo4j_capture_data_change_node_payload.h
 *
 * 
 */

#ifndef _neo4j_capture_data_change_node_payload_H_
#define _neo4j_capture_data_change_node_payload_H_
...
typedef struct neo4j_capture_data_change_node_payload_t neo4j_capture_data_change_node_payload_t;

#include "neo4j_capture_data_change_node_payload_after.h"



typedef struct neo4j_capture_data_change_node_payload_t {
    struct neo4j_capture_data_change_node_payload_after_t *after; //model
    char *before; // string
    char *id; // string
    char *type; // string

} neo4j_capture_data_change_node_payload_t;
...
#endif /* _neo4j_capture_data_change_node_payload_H_ */
