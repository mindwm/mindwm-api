/*
 * neo4j_change_data_capture_relationship_payload_end.h
 *
 * 
 */

#ifndef _neo4j_change_data_capture_relationship_payload_end_H_
#define _neo4j_change_data_capture_relationship_payload_end_H_
...
typedef struct neo4j_change_data_capture_relationship_payload_end_t neo4j_change_data_capture_relationship_payload_end_t;

#include "any_type.h"



typedef struct neo4j_change_data_capture_relationship_payload_end_t {
    char *id; // string
    list_t* ids; //map
    list_t *labels; //primitive container

} neo4j_change_data_capture_relationship_payload_end_t;
...
#endif /* _neo4j_change_data_capture_relationship_payload_end_H_ */
