/*
 * neo4j_change_data_capture_node_payload_after.h
 *
 * 
 */

#ifndef _neo4j_change_data_capture_node_payload_after_H_
#define _neo4j_change_data_capture_node_payload_after_H_
...
typedef struct neo4j_change_data_capture_node_payload_after_t neo4j_change_data_capture_node_payload_after_t;

#include "any_type.h"



typedef struct neo4j_change_data_capture_node_payload_after_t {
    list_t *labels; //primitive container
    list_t* properties; //map

} neo4j_change_data_capture_node_payload_after_t;
...
#endif /* _neo4j_change_data_capture_node_payload_after_H_ */
