...
@class OAIGraphRelationshipAllOfData;



@protocol OAIGraphRelationship
@end

@interface OAIGraphRelationship : NSMutableDictionary
...
@property(nonatomic) OAIGraphRelationshipAllOfData* data;
