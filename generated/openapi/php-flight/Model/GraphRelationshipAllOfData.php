...
class GraphRelationshipAllOfData  implements \JsonSerializable
{
        /**
     * @var 
    ...
    /**
     * @var Neo4jCaptureDataChangeRelationshipPayload
     * @SerializedName("payload")
     * @Assert\NotNull()
     * @Assert\Valid()
     * @Assert\Type("\OpenAPIServer\Model\Neo4jCaptureDataChangeRelationshipPayload")
     * @Type("\OpenAPIServer\Model\Neo4jCaptureDataChangeRelationshipPayload")
     */
    public Neo4jCaptureDataChangeRelationshipPayload $payload;
     ...
     * @param Neo4jCaptureDataChangeRelationshipPayload $payload
     */
    public function __construct( $headers, string $messageKey, Neo4jCaptureDataChangeMeta $meta, int $offset, int $partition, string $sourceType, \DateTime $timestamp, string $topic, Neo4jCaptureDataChangeSchema $schema, Neo4jCaptureDataChangeRelationshipPayload $payload)
    {
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            isset($data['payload']) ? Neo4jCaptureDataChangeRelationshipPayload::fromArray($data['payload']) : null, 
        );
    }
