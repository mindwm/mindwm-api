...
class Neo4jCaptureDataChangeMeta(Model):
    ...
    def __init__(self, operation: str=None, source: Neo4jCaptureDataChangeMetaSource=None, timestamp: int=None, tx_event_id: int=None, tx_events_count: int=None, tx_id: int=None, username: str=None):
        """Neo4jCaptureDataChangeMeta - a model defined in OpenAPI
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'Neo4jCaptureDataChangeMeta':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The Neo4jCaptureDataChange_meta of this Neo4jCaptureDataChangeMeta.
        """
    ...
    @tx_event_id.setter
    def tx_event_id(self, tx_event_id):
        ...
        if tx_event_id is None:
            raise ValueError("Invalid value for `tx_event_id`, must not be `None`")

        self._tx_event_id = tx_event_id

    @property
    def tx_events_count(self):
    ...
    def tx_events_count(self, tx_events_count):
        ...
        if tx_events_count is None:
            raise ValueError("Invalid value for `tx_events_count`, must not be `None`")
