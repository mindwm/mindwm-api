...
/*
 * OAIGraphRelationship_allOf_data.h
 *
 * 
 */

#ifndef OAIGraphRelationship_allOf_data_H
#define OAIGraphRelationship_allOf_data_H
...
class OAIGraphRelationship_allOf_data : public OAIObject {
public:
    OAIGraphRelationship_allOf_data();
    OAIGraphRelationship_allOf_data(QString json);
    ~OAIGraphRelationship_allOf_data() override;
    ...
    OAINeo4jCaptureDataChangeRelationshipPayload getPayload() const;
    void setPayload(const OAINeo4jCaptureDataChangeRelationshipPayload &payload);
...
private:
    ...
    OAINeo4jCaptureDataChangeRelationshipPayload payload;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGraphRelationship_allOf_data)

#endif // OAIGraphRelationship_allOf_data_H
