...
#ifndef OAIIoDocument_H
#define OAIIoDocument_H
...
class OAIIoDocument : public OAIObject {
public:
    OAIIoDocument();
    OAIIoDocument(QString json);
    ~OAIIoDocument() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIoDocument)

#endif // OAIIoDocument_H
