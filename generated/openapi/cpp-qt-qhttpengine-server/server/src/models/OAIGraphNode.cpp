...
QString OAIGraphNode::getId() const {
    return id;
}
void OAIGraphNode::setId(const QString &id) {
    this->id = id;
    this->m_id_isSet = true;
}

bool OAIGraphNode::is_id_Set() const{
    return m_id_isSet;
}

bool OAIGraphNode::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIGraphNode::getSource() const {
    return source;
}
void OAIGraphNode::setSource(const QString &source) {
    this->source = source;
    this->m_source_isSet = true;
}

bool OAIGraphNode::is_source_Set() const{
    return m_source_isSet;
}

bool OAIGraphNode::is_source_Valid() const{
    return m_source_isValid;
}

QString OAIGraphNode::getSpecversion() const {
    return specversion;
}
void OAIGraphNode::setSpecversion(const QString &specversion) {
    this->specversion = specversion;
    this->m_specversion_isSet = true;
}

bool OAIGraphNode::is_specversion_Set() const{
    return m_specversion_isSet;
}

bool OAIGraphNode::is_specversion_Valid() const{
    return m_specversion_isValid;
}

QString OAIGraphNode::getType() const {
    return type;
}
void OAIGraphNode::setType(const QString &type) {
    this->type = type;
    this->m_type_isSet = true;
}

bool OAIGraphNode::is_type_Set() const{
    return m_type_isSet;
}

bool OAIGraphNode::is_type_Valid() const{
    return m_type_isValid;
}

QString OAIGraphNode::getDatacontenttype() const {
    return datacontenttype;
}
void OAIGraphNode::setDatacontenttype(const QString &datacontenttype) {
    this->datacontenttype = datacontenttype;
    this->m_datacontenttype_isSet = true;
}

bool OAIGraphNode::is_datacontenttype_Set() const{
    return m_datacontenttype_isSet;
}

bool OAIGraphNode::is_datacontenttype_Valid() const{
    return m_datacontenttype_isValid;
}

QString OAIGraphNode::getDataschema() const {
    return dataschema;
}
void OAIGraphNode::setDataschema(const QString &dataschema) {
    this->dataschema = dataschema;
    this->m_dataschema_isSet = true;
}

bool OAIGraphNode::is_dataschema_Set() const{
    return m_dataschema_isSet;
}

bool OAIGraphNode::is_dataschema_Valid() const{
    return m_dataschema_isValid;
}

QString OAIGraphNode::getSubject() const {
    return subject;
}
void OAIGraphNode::setSubject(const QString &subject) {
    this->subject = subject;
    this->m_subject_isSet = true;
}

bool OAIGraphNode::is_subject_Set() const{
    return m_subject_isSet;
}

bool OAIGraphNode::is_subject_Valid() const{
    return m_subject_isValid;
}

QDateTime OAIGraphNode::getTime() const {
    return time;
}
void OAIGraphNode::setTime(const QDateTime &time) {
    this->time = time;
    this->m_time_isSet = true;
}

bool OAIGraphNode::is_time_Set() const{
    return m_time_isSet;
}

bool OAIGraphNode::is_time_Valid() const{
    return m_time_isValid;
}

OAIGraphNode_allOf_data OAIGraphNode::getData() const {
    return data;
}
void OAIGraphNode::setData(const OAIGraphNode_allOf_data &data) {
    this->data = data;
    this->m_data_isSet = true;
}

bool OAIGraphNode::is_data_Set() const{
    return m_data_isSet;
}

bool OAIGraphNode::is_data_Valid() const{
    return m_data_isValid;
}

QString OAIGraphNode::getDataBase64() const {
    return data_base64;
}
void OAIGraphNode::setDataBase64(const QString &data_base64) {
    this->data_base64 = data_base64;
    this->m_data_base64_isSet = true;
}

bool OAIGraphNode::is_data_base64_Set() const{
    return m_data_base64_isSet;
}

bool OAIGraphNode::is_data_base64_Valid() const{
