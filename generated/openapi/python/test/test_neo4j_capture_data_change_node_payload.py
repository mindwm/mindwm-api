...
class TestNeo4jCaptureDataChangeNodePayload(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Neo4jCaptureDataChangeNodePayload:
        ...
        """
        model = Neo4jCaptureDataChangeNodePayload()
        if include_optional:
    ...
    def testNeo4jCaptureDataChangeNodePayload(self):
        """Test Neo4jCaptureDataChangeNodePayload"""
