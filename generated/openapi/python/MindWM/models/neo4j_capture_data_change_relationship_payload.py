...
class Neo4jCaptureDataChangeRelationshipPayload(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "end": Neo4jCaptureDataChangeRelationshipPayloadEnd.from_dict(obj["end"]) if obj.get("end") is not None else None,
            "id": obj.get("id"),
            "label": obj.get("label"),
            "start": Neo4jCaptureDataChangeRelationshipPayloadEnd.from_dict(obj["start"]) if obj.get("start") is not None else None,
            "type": obj.get("type")
        })
        return _obj
