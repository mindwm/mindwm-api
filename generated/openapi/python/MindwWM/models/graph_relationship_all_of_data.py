...
class GraphRelationshipAllOfData(BaseModel):
    ...
    timestamp: datetime
    topic: StrictStr
    var_schema: Neo4jCaptureDataChangeSchema = Field(alias="schema")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meta": Neo4jCaptureDataChangeMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "offset": obj.get("offset"),
            "partition": obj.get("partition"),
            "source_type": obj.get("source_type"),
            "timestamp": obj.get("timestamp"),
            "topic": obj.get("topic"),
            "schema": Neo4jCaptureDataChangeSchema.from_dict(obj["schema"]) if obj.get("schema") is not None else None,
            "payload": Neo4jCaptureDataChangeRelationshipPayload.from_dict(obj["payload"]) if obj.get("payload") is not None else None
        })
        return _obj
