...
/*
 * OAIGraphRelationship.h
 *
 * 
 */

#ifndef OAIGraphRelationship_H
#define OAIGraphRelationship_H
...
namespace OpenAPI {
class OAIGraphRelationship_allOf_data;

class OAIGraphRelationship : public OAIObject {
public:
    OAIGraphRelationship();
    OAIGraphRelationship(QString json);
    ~OAIGraphRelationship() override;
    ...
    OAIGraphRelationship_allOf_data getData() const;
    void setData(const OAIGraphRelationship_allOf_data &data);
...
private:
    ...
    OAIGraphRelationship_allOf_data m_data;
    bool m_data_isSet;
    bool m_data_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGraphRelationship)

#endif // OAIGraphRelationship_H
