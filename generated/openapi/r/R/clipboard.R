...
#' @field data  \link{ClipboardPayload} [optional]
...
Clipboard <- R6::R6Class(
  ...
  public = list(
    ...
    #' Initialize a new Clipboard class.
    #'
    #' @description
    #' Initialize a new Clipboard class.
    #'
    ...
    #' To JSON String
    #'
    #' @return Clipboard in JSON format
    #' @export
    toJSON = function() {
      ClipboardObject <- list()
      if (!is.null(self$`id`)) {
        ClipboardObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`source`)) {
        ClipboardObject[["source"]] <-
          self$`source`
      }
      if (!is.null(self$`specversion`)) {
        ClipboardObject[["specversion"]] <-
          self$`specversion`
      }
      if (!is.null(self$`type`)) {
        ClipboardObject[["type"]] <-
          self$`type`
      }
      if (!is.null(self$`datacontenttype`)) {
        ClipboardObject[["datacontenttype"]] <-
          self$`datacontenttype`
      }
      if (!is.null(self$`dataschema`)) {
        ClipboardObject[["dataschema"]] <-
          self$`dataschema`
      }
      if (!is.null(self$`subject`)) {
        ClipboardObject[["subject"]] <-
          self$`subject`
      }
      if (!is.null(self$`time`)) {
        ClipboardObject[["time"]] <-
          self$`time`
      }
      ...
      if (!is.null(self$`data_base64`)) {
        ClipboardObject[["data_base64"]] <-
          self$`data_base64`
      }
      for (key in names(self$additional_properties)) {
        ClipboardObject[[key]] <- self$additional_properties[[key]]
      }

      ClipboardObject
    },
    #' Deserialize JSON string into an instance of Clipboard
    #'
    #' @description
    #' Deserialize JSON string into an instance of Clipboard
    #'
    #' @param input_json the JSON input
    #' @return the instance of Clipboard
    #' @export
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`data`)) {
        `data_object` <- ClipboardPayload$new()
    ...
    fromJSONString = function(input_json) {
      ...
      self$`subject` <- this_object$`subject`
      self$`time` <- this_object$`time`
      self$`data` <- ClipboardPayload$new()$fromJSON(jsonlite::toJSON(this_object$`data`, auto_unbox = TRUE, digits = NA))
      self$`data_base64` <- this_object$`data_base64`
      # process additional properties/fields in the payload
      for (key in names(this_object)) {
        if (!(key %in% self$`_field_list`)) { # json key not in list of fields
    ...
    #' Validate JSON input with respect to Clipboard
    #'
    #' @description
    #' Validate JSON input with respect to Clipboard and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for Clipboard: the required field `id` is missing."))
      }
      ...
      if (!is.null(input_json$`source`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for Clipboard: the required field `source` is missing."))
      }
      ...
      if (!is.null(input_json$`specversion`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for Clipboard: the required field `specversion` is missing."))
      }
      ...
      if (!is.null(input_json$`type`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for Clipboard: the required field `type` is missing."))
      }
    },
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of Clipboard
    #' @export
    toString = function() {
      self$toJSONString()
    },
    ...
    isValid = function() {
      ...
      if (!str_detect(self$`source`, "^mindwm\\\\.[a-zA-Z0-9_]{1,32}\\\\.[a-zA-Z0-9-]{1,63}\\.clipboard$")) {
        return(FALSE)
      }
    ...
    getInvalidFields = function() {
      ...
      if (!str_detect(self$`source`, "^mindwm\\\\.[a-zA-Z0-9_]{1,32}\\\\.[a-zA-Z0-9-]{1,63}\\.clipboard$")) {
        invalid_fields["source"] <- "Invalid value for `source`, must conform to the pattern ^mindwm\\\\.[a-zA-Z0-9_]{1,32}\\\\.[a-zA-Z0-9-]{1,63}\\.clipboard$."
      }
...
# Clipboard$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
