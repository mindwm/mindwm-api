#' Create a new GraphNodeAllOfData
#'
#' @description
#' GraphNodeAllOfData Class
#'
#' @docType class
#' @title GraphNodeAllOfData
#' @description GraphNodeAllOfData Class
...
#' @field payload  \link{Neo4jCaptureDataChangeNodePayload}
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
GraphNodeAllOfData <- R6::R6Class(
  "GraphNodeAllOfData",
  public = list(
    `headers` = NULL,
    `message_key` = NULL,
    ...
    `schema` = NULL,
    `payload` = NULL,
    #' Initialize a new GraphNodeAllOfData class.
    #'
    #' @description
    #' Initialize a new GraphNodeAllOfData class.
    #'
    ...
    #' To JSON String
    #'
    #' @return GraphNodeAllOfData in JSON format
    #' @export
    toJSON = function() {
      GraphNodeAllOfDataObject <- list()
      if (!is.null(self$`headers`)) {
        GraphNodeAllOfDataObject[["headers"]] <-
          self$`headers`
      }
      if (!is.null(self$`message_key`)) {
        GraphNodeAllOfDataObject[["message_key"]] <-
          self$`message_key`
      }
      if (!is.null(self$`meta`)) {
        GraphNodeAllOfDataObject[["meta"]] <-
          self$`meta`$toJSON()
      }
      if (!is.null(self$`offset`)) {
        GraphNodeAllOfDataObject[["offset"]] <-
          self$`offset`
      }
      if (!is.null(self$`partition`)) {
        GraphNodeAllOfDataObject[["partition"]] <-
          self$`partition`
      }
      if (!is.null(self$`source_type`)) {
        GraphNodeAllOfDataObject[["source_type"]] <-
          self$`source_type`
      }
      if (!is.null(self$`timestamp`)) {
        GraphNodeAllOfDataObject[["timestamp"]] <-
          self$`timestamp`
      }
      if (!is.null(self$`topic`)) {
        GraphNodeAllOfDataObject[["topic"]] <-
          self$`topic`
      }
      if (!is.null(self$`schema`)) {
        GraphNodeAllOfDataObject[["schema"]] <-
          self$`schema`$toJSON()
      }
      if (!is.null(self$`payload`)) {
        GraphNodeAllOfDataObject[["payload"]] <-
          self$`payload`$toJSON()
      }
      GraphNodeAllOfDataObject
    },
    #' Deserialize JSON string into an instance of GraphNodeAllOfData
    #'
    #' @description
    #' Deserialize JSON string into an instance of GraphNodeAllOfData
    #'
    #' @param input_json the JSON input
    #' @return the instance of GraphNodeAllOfData
    #' @export
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`payload`)) {
        `payload_object` <- Neo4jCaptureDataChangeNodePayload$new()
    ...
    fromJSONString = function(input_json) {
      ...
      self$`payload` <- Neo4jCaptureDataChangeNodePayload$new()$fromJSON(jsonlite::toJSON(this_object$`payload`, auto_unbox = TRUE, digits = NA))
      self
    },
    #' Validate JSON input with respect to GraphNodeAllOfData
    #'
    #' @description
    #' Validate JSON input with respect to GraphNodeAllOfData and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`headers`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for GraphNodeAllOfData: the required field `headers` is missing."))
      }
      ...
      if (!is.null(input_json$`message_key`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for GraphNodeAllOfData: the required field `message_key` is missing."))
      }
      # check the required field `meta`
      if (!is.null(input_json$`meta`)) {
        stopifnot(R6::is.R6(input_json$`meta`))
      } else {
        stop(paste("The JSON input `", input, "` is invalid for GraphNodeAllOfData: the required field `meta` is missing."))
      }
      ...
      if (!is.null(input_json$`offset`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for GraphNodeAllOfData: the required field `offset` is missing."))
      }
      ...
      if (!is.null(input_json$`partition`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for GraphNodeAllOfData: the required field `partition` is missing."))
      }
      ...
      if (!is.null(input_json$`source_type`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for GraphNodeAllOfData: the required field `source_type` is missing."))
      }
      ...
      if (!is.null(input_json$`timestamp`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for GraphNodeAllOfData: the required field `timestamp` is missing."))
      }
      ...
      if (!is.null(input_json$`topic`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for GraphNodeAllOfData: the required field `topic` is missing."))
      }
      # check the required field `schema`
      if (!is.null(input_json$`schema`)) {
        stopifnot(R6::is.R6(input_json$`schema`))
      } else {
        stop(paste("The JSON input `", input, "` is invalid for GraphNodeAllOfData: the required field `schema` is missing."))
      }
      # check the required field `payload`
      if (!is.null(input_json$`payload`)) {
        stopifnot(R6::is.R6(input_json$`payload`))
      } else {
        stop(paste("The JSON input `", input, "` is invalid for GraphNodeAllOfData: the required field `payload` is missing."))
      }
    },
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of GraphNodeAllOfData
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# GraphNodeAllOfData$unlock()
#
## Below is an example to define the print function
# GraphNodeAllOfData$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# GraphNodeAllOfData$lock()
