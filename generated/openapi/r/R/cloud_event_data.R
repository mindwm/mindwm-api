...
#'
#' @description CloudEventData Class
#'
...
CloudEventData <- R6::R6Class(
  ...
  public = list(
    ...
    #' Initialize a new CloudEventData.
    #'
    #' @description
    #' Initialize a new CloudEventData.
    #'
    ...
    initialize = function(instance = NULL) {
      if (is.null(instance)) {
        ...
        stop(paste("Failed to initialize CloudEventData with anyOf schemas character, numeric. Provided class name: ",
                   get(class(instance)[[1]], pos = -1)$classname))
      }
    },
    #' Deserialize JSON string into an instance of CloudEventData.
    #'
    #' @description
    #' Deserialize JSON string into an instance of CloudEventData.
    ...
    fromJSON = function(input) {
      ...
      # no match
      stop(paste("No match found when deserializing the input into CloudEventData with anyOf schemas character, numeric. Details: >>",
                 paste(error_messages, collapse = " >> ")))
    },
    #' Serialize CloudEventData to JSON string.
    #'
    #' @description
    #' Serialize CloudEventData to JSON string.
    #'
    #' @return JSON string representation of the CloudEventData.
    #' @export
    ...
    #' Serialize CloudEventData to JSON.
    #'
    #' @return JSON representation of the CloudEventData.
    #' @export
    toJSON = function() {
      if (!is.null(self$actual_instance)) {
    ...
    #' Validate the input JSON with respect to CloudEventData.
    #'
    #' @description
    #' Validate the input JSON with respect to CloudEventData and
...
#CloudEventData$unlock()
#
## Below is an example to define the print function
#CloudEventData$set("public", "print", function(...) {
#  print(jsonlite::prettify(self$toJSONString()))
#  invisible(self)
#})
