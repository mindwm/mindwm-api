#' Create a new GraphRelationshipAllOfData
#'
#' @description
#' GraphRelationshipAllOfData Class
#'
#' @docType class
#' @title GraphRelationshipAllOfData
#' @description GraphRelationshipAllOfData Class
...
#' @field payload  \link{Neo4jCaptureDataChangeRelationshipPayload}
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
GraphRelationshipAllOfData <- R6::R6Class(
  ...
  public = list(
    ...
    `schema` = NULL,
    `payload` = NULL,
    #' Initialize a new GraphRelationshipAllOfData class.
    #'
    #' @description
    #' Initialize a new GraphRelationshipAllOfData class.
    #'
    ...
    #' To JSON String
    #'
    #' @return GraphRelationshipAllOfData in JSON format
    #' @export
    toJSON = function() {
      GraphRelationshipAllOfDataObject <- list()
      if (!is.null(self$`headers`)) {
        GraphRelationshipAllOfDataObject[["headers"]] <-
          self$`headers`
      }
      if (!is.null(self$`message_key`)) {
        GraphRelationshipAllOfDataObject[["message_key"]] <-
          self$`message_key`
      }
      if (!is.null(self$`meta`)) {
        GraphRelationshipAllOfDataObject[["meta"]] <-
          self$`meta`$toJSON()
      }
      if (!is.null(self$`offset`)) {
        GraphRelationshipAllOfDataObject[["offset"]] <-
          self$`offset`
      }
      if (!is.null(self$`partition`)) {
        GraphRelationshipAllOfDataObject[["partition"]] <-
          self$`partition`
      }
      if (!is.null(self$`source_type`)) {
        GraphRelationshipAllOfDataObject[["source_type"]] <-
          self$`source_type`
      }
      if (!is.null(self$`timestamp`)) {
        GraphRelationshipAllOfDataObject[["timestamp"]] <-
          self$`timestamp`
      }
      if (!is.null(self$`topic`)) {
        GraphRelationshipAllOfDataObject[["topic"]] <-
          self$`topic`
      }
      if (!is.null(self$`schema`)) {
        GraphRelationshipAllOfDataObject[["schema"]] <-
          self$`schema`$toJSON()
      }
      if (!is.null(self$`payload`)) {
        GraphRelationshipAllOfDataObject[["payload"]] <-
          self$`payload`$toJSON()
      }
      GraphRelationshipAllOfDataObject
    },
    #' Deserialize JSON string into an instance of GraphRelationshipAllOfData
    #'
    #' @description
    #' Deserialize JSON string into an instance of GraphRelationshipAllOfData
    #'
    #' @param input_json the JSON input
    #' @return the instance of GraphRelationshipAllOfData
    #' @export
    fromJSON = function(input_json) {
      this_object <- jsonlite::fromJSON(input_json)
      if (!is.null(this_object$`headers`)) {
        self$`headers` <- this_object$`headers`
      }
      ...
      if (!is.null(this_object$`payload`)) {
        `payload_object` <- Neo4jCaptureDataChangeRelationshipPayload$new()
    ...
    fromJSONString = function(input_json) {
      ...
      self$`payload` <- Neo4jCaptureDataChangeRelationshipPayload$new()$fromJSON(jsonlite::toJSON(this_object$`payload`, auto_unbox = TRUE, digits = NA))
      self
    },
    #' Validate JSON input with respect to GraphRelationshipAllOfData
    #'
    #' @description
    #' Validate JSON input with respect to GraphRelationshipAllOfData and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`headers`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for GraphRelationshipAllOfData: the required field `headers` is missing."))
      }
      ...
      if (!is.null(input_json$`message_key`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for GraphRelationshipAllOfData: the required field `message_key` is missing."))
      }
      # check the required field `meta`
      if (!is.null(input_json$`meta`)) {
        stopifnot(R6::is.R6(input_json$`meta`))
      } else {
        stop(paste("The JSON input `", input, "` is invalid for GraphRelationshipAllOfData: the required field `meta` is missing."))
      }
      ...
      if (!is.null(input_json$`offset`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for GraphRelationshipAllOfData: the required field `offset` is missing."))
      }
      ...
      if (!is.null(input_json$`partition`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for GraphRelationshipAllOfData: the required field `partition` is missing."))
      }
      ...
      if (!is.null(input_json$`source_type`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for GraphRelationshipAllOfData: the required field `source_type` is missing."))
      }
      ...
      if (!is.null(input_json$`timestamp`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for GraphRelationshipAllOfData: the required field `timestamp` is missing."))
      }
      ...
      if (!is.null(input_json$`topic`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for GraphRelationshipAllOfData: the required field `topic` is missing."))
      }
      # check the required field `schema`
      if (!is.null(input_json$`schema`)) {
        stopifnot(R6::is.R6(input_json$`schema`))
      } else {
        stop(paste("The JSON input `", input, "` is invalid for GraphRelationshipAllOfData: the required field `schema` is missing."))
      }
      # check the required field `payload`
      if (!is.null(input_json$`payload`)) {
        stopifnot(R6::is.R6(input_json$`payload`))
      } else {
        stop(paste("The JSON input `", input, "` is invalid for GraphRelationshipAllOfData: the required field `payload` is missing."))
      }
    },
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of GraphRelationshipAllOfData
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# GraphRelationshipAllOfData$unlock()
#
## Below is an example to define the print function
# GraphRelationshipAllOfData$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# GraphRelationshipAllOfData$lock()
