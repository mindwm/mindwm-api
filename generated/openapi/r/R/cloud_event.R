...
#' @docType class
#' @title CloudEvent
#' @description CloudEvent Class
#' @format An \code{R6Class} generator object
#' @field id Identifies the event. character
#' @field source Identifies the context in which an event happened. character
#' @field specversion The version of the CloudEvents specification which the event uses. character
#' @field type Describes the type of event related to the originating occurrence. character
...
CloudEvent <- R6::R6Class(
  ...
  public = list(
    ...
    `data` = NULL,
    `data_base64` = NULL,
    #' Initialize a new CloudEvent class.
    #'
    #' @description
    #' Initialize a new CloudEvent class.
    #'
    ...
    #' @export
    initialize = function(`id`, `source`, `specversion`, `type`, `datacontenttype` = NULL, `dataschema` = NULL, `subject` = NULL, `time` = NULL, `data` = NULL, `data_base64` = NULL, ...) {
      if (!missing(`id`)) {
    ...
    #' To JSON String
    #'
    #' @return CloudEvent in JSON format
    #' @export
    toJSON = function() {
      CloudEventObject <- list()
      if (!is.null(self$`id`)) {
        CloudEventObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`source`)) {
        CloudEventObject[["source"]] <-
          self$`source`
      }
      if (!is.null(self$`specversion`)) {
        CloudEventObject[["specversion"]] <-
          self$`specversion`
      }
      if (!is.null(self$`type`)) {
        CloudEventObject[["type"]] <-
          self$`type`
      }
      if (!is.null(self$`datacontenttype`)) {
        CloudEventObject[["datacontenttype"]] <-
          self$`datacontenttype`
      }
      if (!is.null(self$`dataschema`)) {
        CloudEventObject[["dataschema"]] <-
          self$`dataschema`
      }
      if (!is.null(self$`subject`)) {
        CloudEventObject[["subject"]] <-
          self$`subject`
      }
      if (!is.null(self$`time`)) {
        CloudEventObject[["time"]] <-
          self$`time`
      }
    ...
    #' Deserialize JSON string into an instance of CloudEvent
    #'
    #' @description
    #' Deserialize JSON string into an instance of CloudEvent
    #'
    #' @param input_json the JSON input
    #' @return the instance of CloudEvent
    #' @export
    ...
    #' Validate JSON input with respect to CloudEvent
    #'
    #' @description
    #' Validate JSON input with respect to CloudEvent and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for CloudEvent: the required field `id` is missing."))
      }
      ...
      if (!is.null(input_json$`source`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for CloudEvent: the required field `source` is missing."))
      }
      ...
      if (!is.null(input_json$`specversion`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for CloudEvent: the required field `specversion` is missing."))
      }
      ...
      if (!is.null(input_json$`type`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for CloudEvent: the required field `type` is missing."))
      }
    },
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of CloudEvent
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# CloudEvent$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
