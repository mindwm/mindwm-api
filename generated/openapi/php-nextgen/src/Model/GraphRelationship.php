...
class GraphRelationship implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'GraphRelationship';
    ...
    */
     ...
     */
    public function getData(): ?\OpenAPI\Client\Model\GraphRelationshipAllOfData
    {
     ...
     * @return $this
     */
    public function setData(?\OpenAPI\Client\Model\GraphRelationshipAllOfData $data): static
    {
        if (is_null($data)) {
