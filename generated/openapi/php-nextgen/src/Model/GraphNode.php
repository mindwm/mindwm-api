...
class GraphNode implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'GraphNode';
    ...
    protected static array $openAPITypes = [
        ...
        'subject' => 'string',
        'time' => '\DateTime',
        'data' => '\OpenAPI\Client\Model\GraphNodeAllOfData',
        'data_base64' => 'string'
    ];
    ...
    */
    ...
    public function setId(string $id): static
    {
        ...
        if ((mb_strlen($id) < 1)) {
            throw new InvalidArgumentException('invalid length for $id when calling GraphNode., must be bigger than or equal to 1.');
        }
    ...
    public function setSpecversion(string $specversion): static
    {
        ...
        if ((mb_strlen($specversion) < 1)) {
            throw new InvalidArgumentException('invalid length for $specversion when calling GraphNode., must be bigger than or equal to 1.');
        }
    ...
    public function setDatacontenttype(?string $datacontenttype): static
    {
        ...
        if ((mb_strlen($datacontenttype) < 1)) {
            throw new InvalidArgumentException('invalid length for $datacontenttype when calling GraphNode., must be bigger than or equal to 1.');
        }
    ...
    public function setDataschema(?string $dataschema): static
    {
        ...
        if ((mb_strlen($dataschema) < 1)) {
            throw new InvalidArgumentException('invalid length for $dataschema when calling GraphNode., must be bigger than or equal to 1.');
        }
    ...
    public function setSubject(?string $subject): static
    {
        ...
        if ((mb_strlen($subject) < 1)) {
            throw new InvalidArgumentException('invalid length for $subject when calling GraphNode., must be bigger than or equal to 1.');
        }
    ...
    public function setTime(?\DateTime $time): static
    {
        ...
        if ((mb_strlen($time) < 1)) {
            throw new InvalidArgumentException('invalid length for $time when calling GraphNode., must be bigger than or equal to 1.');
        }
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\GraphNodeAllOfData|null
     */
    public function getData(): ?\OpenAPI\Client\Model\GraphNodeAllOfData
    {
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\GraphNodeAllOfData|null $data data
     *
     * @return $this
     */
    public function setData(?\OpenAPI\Client\Model\GraphNodeAllOfData $data): static
    {
        if (is_null($data)) {
