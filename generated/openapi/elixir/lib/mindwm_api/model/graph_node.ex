...
defmodule MindwmAPI.Model.GraphNode do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :time => DateTime.t | nil,
    :data => MindwmAPI.Model.GraphNodeAllOfData.t | nil,
  ...
  def decode(value) do
    value
     ...
     |> Deserializer.deserialize(:data, :struct, MindwmAPI.Model.GraphNodeAllOfData)
  end
end
