...
/**
 * IoDocumentEvent Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class IoDocumentEvent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IoDocumentEvent';
    ...
    protected static $openAPITypes = [
        ...
        'subject' => 'string',
        'time' => '\DateTime',
        'data' => '\OpenAPI\Client\Model\IoDocument',
        'data_base64' => 'string'
    ];
    ...
    */
    ...
    public function setId($id)
    {
        ...
        if ((mb_strlen($id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $id when calling IoDocumentEvent., must be bigger than or equal to 1.');
        }
    ...
    public function setSpecversion($specversion)
    {
        ...
        if ((mb_strlen($specversion) < 1)) {
            throw new \InvalidArgumentException('invalid length for $specversion when calling IoDocumentEvent., must be bigger than or equal to 1.');
        }
    ...
    public function setDatacontenttype($datacontenttype)
    {
        ...
        if ((mb_strlen($datacontenttype) < 1)) {
            throw new \InvalidArgumentException('invalid length for $datacontenttype when calling IoDocumentEvent., must be bigger than or equal to 1.');
        }
    ...
    public function setDataschema($dataschema)
    {
        ...
        if ((mb_strlen($dataschema) < 1)) {
            throw new \InvalidArgumentException('invalid length for $dataschema when calling IoDocumentEvent., must be bigger than or equal to 1.');
        }
    ...
    public function setTime($time)
    {
        ...
        if ((mb_strlen($time) < 1)) {
            throw new \InvalidArgumentException('invalid length for $time when calling IoDocumentEvent., must be bigger than or equal to 1.');
        }
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\IoDocument|null
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\IoDocument|null $data data
     *
     * @return self
     */
