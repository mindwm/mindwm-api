extends Resource
class_name Neo4jCaptureDataChangeMeta
...
# Neo4jCaptureDataChangeMeta Model


# Required: True
# isArray: false
@export var operation: AnyType:
	set(value):
...
# Required: True
# isArray: false
@export var source: Neo4jCaptureDataChangeMetaSource:
	set(value):
...
# Required: True
# isArray: false
@export var txEventsCount: AnyType:
	set(value):
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("source"):
		me.source = Neo4jCaptureDataChange_meta_source.bzz_denormalize_single(from_dict["source"])
