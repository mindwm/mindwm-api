extends Resource
class_name Neo4jCaptureDataChange
...
# Required: True
# isArray: false
@export var messageUnderscorekey: AnyType:
	set(value):
...
# Required: True
# isArray: false
@export var meta: Neo4jCaptureDataChangeMeta:
	set(value):
...
# Required: True
# isArray: false
@export var sourceUnderscoretype: AnyType:
	set(value):
...
# Required: True
# isArray: false
@export var schema: Neo4jCaptureDataChangeSchema:
	set(value):
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("meta"):
		me.meta = Neo4jCaptureDataChange_meta.bzz_denormalize_single(from_dict["meta"])
	...
	if from_dict.has("schema"):
		me.schema = Neo4jCaptureDataChange_schema.bzz_denormalize_single(from_dict["schema"])
