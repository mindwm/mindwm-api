...
function Initialize-Neo4jCaptureDataChangeNodePayload {
    ...
    Process {
        'Creating PSCustomObject: MindWM => Neo4jCaptureDataChangeNodePayload' | Write-Debug
...
function ConvertFrom-JsonToNeo4jCaptureDataChangeNodePayload {
    ...
    Process {
        'Converting JSON to PSCustomObject: MindWM => Neo4jCaptureDataChangeNodePayload' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
