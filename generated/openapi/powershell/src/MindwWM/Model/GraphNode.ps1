...
GraphNode<PSCustomObject>
#>

function Initialize-GraphNode {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: MindwWM => GraphNode' | Write-Debug
...
Convert from JSON to GraphNode<PSCustomObject>
...
GraphNode<PSCustomObject>
#>
function ConvertFrom-JsonToGraphNode {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: MindwWM => GraphNode' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json
        $GraphNodeAdditionalProperties = @{}

        # check if Json contains properties not defined in GraphNode
        ...
        foreach ($name in $JsonParameters.PsObject.Properties.Name) {
            ...
            if (!($AllProperties.Contains($name))) {
                $GraphNodeAdditionalProperties[$name] = $JsonParameters.PSobject.Properties[$name].value
            }
        }
        ...
        $PSO = [PSCustomObject]@{
            ...
            "data" = ${VarData}
            "data_base64" = ${DataBase64}
            "AdditionalProperties" = $GraphNodeAdditionalProperties
        }
