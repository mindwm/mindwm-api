...
GraphNodeAllOfData<PSCustomObject>
#>

function Initialize-GraphNodeAllOfData {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: MindwWM => GraphNodeAllOfData' | Write-Debug
...
Convert from JSON to GraphNodeAllOfData<PSCustomObject>
...
GraphNodeAllOfData<PSCustomObject>
#>
function ConvertFrom-JsonToGraphNodeAllOfData {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: MindwWM => GraphNodeAllOfData' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GraphNodeAllOfData
