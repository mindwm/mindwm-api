...
function Initialize-Clipboard {
    ...
    Process {
        'Creating PSCustomObject: MindwWM => Clipboard' | Write-Debug
...
Convert from JSON to Clipboard<PSCustomObject>
...
Clipboard<PSCustomObject>
#>
function ConvertFrom-JsonToClipboard {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: MindwWM => Clipboard' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        foreach ($name in $JsonParameters.PsObject.Properties.Name) {
            ...
            if (!($AllProperties.Contains($name))) {
                $ClipboardAdditionalProperties[$name] = $JsonParameters.PSobject.Properties[$name].value
            }
        }
