...
function Initialize-Neo4jCaptureDataChangeRelationshipPayload {
    ...
    Process {
        'Creating PSCustomObject: MindwWM => Neo4jCaptureDataChangeRelationshipPayload' | Write-Debug
...
function ConvertFrom-JsonToNeo4jCaptureDataChangeRelationshipPayload {
    ...
    Process {
        'Converting JSON to PSCustomObject: MindwWM => Neo4jCaptureDataChangeRelationshipPayload' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
