...
Neo4jCaptureDataChange<PSCustomObject>
#>

function Initialize-Neo4jCaptureDataChange {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: MindwWM => Neo4jCaptureDataChange' | Write-Debug
...
Convert from JSON to Neo4jCaptureDataChange<PSCustomObject>
...
Neo4jCaptureDataChange<PSCustomObject>
#>
function ConvertFrom-JsonToNeo4jCaptureDataChange {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: MindwWM => Neo4jCaptureDataChange' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Neo4jCaptureDataChange
