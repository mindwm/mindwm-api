...
namespace MindWM.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Neo4jCaptureDataChange")]
    public partial class Neo4jCaptureDataChange : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Neo4jCaptureDataChange" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected Neo4jCaptureDataChange() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="Neo4jCaptureDataChange" /> class.
        /// </summary>
        ...
        public Neo4jCaptureDataChange(Dictionary<string, Object> headers = default(Dictionary<string, Object>), string messageKey = default(string), Neo4jCaptureDataChangeMeta meta = default(Neo4jCaptureDataChangeMeta), int offset = default(int), int partition = default(int), string sourceType = default(string), DateTime timestamp = default(DateTime), string topic = default(string), Neo4jCaptureDataChangeSchema schema = default(Neo4jCaptureDataChangeSchema), Neo4jCaptureDataChangePayload payload = default(Neo4jCaptureDataChangePayload))
        {
            // to ensure "headers" is required (not null)
            if (headers == null)
            {
                throw new ArgumentNullException("headers is a required property for Neo4jCaptureDataChange and cannot be null");
            }
            this.Headers = headers;
            // to ensure "messageKey" is required (not null)
            if (messageKey == null)
            {
                throw new ArgumentNullException("messageKey is a required property for Neo4jCaptureDataChange and cannot be null");
            }
            this.MessageKey = messageKey;
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new ArgumentNullException("meta is a required property for Neo4jCaptureDataChange and cannot be null");
            }
            this.Meta = meta;
            this.Offset = offset;
            ...
            if (sourceType == null)
            {
                throw new ArgumentNullException("sourceType is a required property for Neo4jCaptureDataChange and cannot be null");
            }
            ...
            if (topic == null)
            {
                throw new ArgumentNullException("topic is a required property for Neo4jCaptureDataChange and cannot be null");
            }
            this.Topic = topic;
            // to ensure "schema" is required (not null)
            if (schema == null)
            {
                throw new ArgumentNullException("schema is a required property for Neo4jCaptureDataChange and cannot be null");
            }
            this.Schema = schema;
            // to ensure "payload" is required (not null)
            if (payload == null)
            {
                throw new ArgumentNullException("payload is a required property for Neo4jCaptureDataChange and cannot be null");
            }
        ...
        public Neo4jCaptureDataChangePayload Payload { get; set; }
