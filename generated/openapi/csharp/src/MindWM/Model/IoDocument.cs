...
namespace MindWM.Model
{
    ...
    /// IoDocument
    /// </summary>
    [DataContract(Name = "IoDocument")]
    public partial class IoDocument : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IoDocument" /> class.
        /// </summary>
        ...
        /// <param name="type">type (required) (default to &quot;IoDocument&quot;).</param>
        ...
        public IoDocument(string id = default(string), string source = default(string), string specversion = default(string), string type = @"IoDocument", string datacontenttype = default(string), string dataschema = default(string), string subject = @"IoDocument", DateTime time = default(DateTime), TmuxPaneIoDocument data = default(TmuxPaneIoDocument), string dataBase64 = default(string))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for IoDocument and cannot be null");
            }
            this.Id = id;
            // to ensure "source" is required (not null)
            if (source == null)
            {
                throw new ArgumentNullException("source is a required property for IoDocument and cannot be null");
            }
            this.Source = source;
            // to ensure "specversion" is required (not null)
            if (specversion == null)
            {
                throw new ArgumentNullException("specversion is a required property for IoDocument and cannot be null");
            }
            this.Specversion = specversion;
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for IoDocument and cannot be null");
            }
            this.Type = type;
