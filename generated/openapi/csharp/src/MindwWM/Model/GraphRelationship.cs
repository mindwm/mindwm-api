...
namespace MindwWM.Model
{
    ...
    /// GraphRelationship
    /// </summary>
    [DataContract(Name = "GraphRelationship")]
    public partial class GraphRelationship : IValidatableObject
    {
        /// <summary>
        /// Defines Source
        /// </summary>
        ...
        {
            /// <summary>
            /// Enum GraphRelationship for value: graph.relationship
            /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GraphRelationship" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GraphRelationship()
        {
        ...
        public GraphRelationship(string id = default(string), SourceEnum source = default(SourceEnum), string specversion = default(string), TypeEnum type = default(TypeEnum), string datacontenttype = default(string), string dataschema = default(string), string subject = default(string), DateTime time = default(DateTime), GraphRelationshipAllOfData data = default(GraphRelationshipAllOfData), string dataBase64 = default(string))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for GraphRelationship and cannot be null");
            }
            this.Id = id;
            this.Source = source;
            ...
            if (specversion == null)
            {
                throw new ArgumentNullException("specversion is a required property for GraphRelationship and cannot be null");
            }
