...
module TestHelper =
  ...
  let createHost() =
      WebHostBuilder()
          ...
          .Configure(Action<IApplicationBuilder> MindWM.App.configureApp)
          .ConfigureServices(Action<IServiceCollection> MindWM.App.configureServices)
