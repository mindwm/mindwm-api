...
A [Giraffe](https://github.com/giraffe-fsharp/Giraffe) server stub for the MindwWM package, created via the [OpenAPI generator](https://github.com/OpenAPITools/openapi-generator/).
