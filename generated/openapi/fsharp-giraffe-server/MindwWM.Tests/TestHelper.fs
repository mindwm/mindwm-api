...
module TestHelper =
  ...
  let createHost() =
      WebHostBuilder()
          ...
          .Configure(Action<IApplicationBuilder> MindwWM.App.configureApp)
          .ConfigureServices(Action<IServiceCollection> MindwWM.App.configureServices)
