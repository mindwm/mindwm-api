...
public struct GraphNode: Codable, JSONEncodable, Hashable {
    ...
    public var data: GraphNodeAllOfData?
    /** Base64 encoded event payload. Must adhere to RFC4648. */
    public var dataBase64: String?

    public init(id: String, source: Source, specversion: String, type: ModelType, datacontenttype: String? = nil, dataschema: String? = nil, subject: String? = nil, time: Date? = nil, data: GraphNodeAllOfData? = nil, dataBase64: String? = nil) {
        self.id = id
        self.source = source
    ...
    public init(from decoder: Decoder) throws {
        ...
        data = try container.decodeIfPresent(GraphNodeAllOfData.self, forKey: .data)
