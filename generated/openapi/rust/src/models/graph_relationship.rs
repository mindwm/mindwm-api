...
pub struct GraphRelationship {
    ...
    pub data: Option<Box<models::GraphRelationshipAllOfData>>,
...
impl GraphRelationship {
    pub fn new(id: String, source: Source, specversion: String, r#type: Type) -> GraphRelationship {
        GraphRelationship {
            id,
            source,
            specversion,
