...
class Clipboard(BaseModel):
    ...
    def source_validate_regular_expression(cls, value):
        ...
        if not re.match(r"mindwm.[a-zA-Z0-9_][a-zA-Z0-9_-]{0,31}\\.(?!-)[a-zA-Z0-9-]{1,63}(?<!-)$", value):
            raise ValueError(r"must validate the regular expression /mindwm.[a-zA-Z0-9_][a-zA-Z0-9_-]{0,31}\\.(?!-)[a-zA-Z0-9-]{1,63}(?<!-)$/")
        return value
