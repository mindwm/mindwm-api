...
module OpenAPIClient
  class Clipboard
    ...
    def initialize(@id : String, @source : String, @specversion : String, @_type : String, @_type : String?, @source : String?, @data : ClipboardPayload?, @datacontenttype : String?, @dataschema : String?, @subject : String?, @time : Time?, @data_base64 : String?)
    end
