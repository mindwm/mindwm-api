...
-- |
data MindwmConfig = MindwmConfig
...
-- | display the config
instance P.Show MindwmConfig where
  show c =
    T.printf
...
-- | constructs a default MindwmConfig
--
-- configHost:
--
-- @https://mindwmw.io/v1@
...
-- @"mindwm/0.1.0.0"@
--
newConfig :: IO MindwmConfig
newConfig = do
    logCxt <- initLogContext
    return $ MindwmConfig
        { configHost = "https://mindwmw.io/v1"
        , configUserAgent = "mindwm/0.1.0.0"
...
addAuthMethod :: AuthMethod auth => MindwmConfig -> auth -> MindwmConfig
addAuthMethod config@MindwmConfig {configAuthMethods = as} a =
  config { configAuthMethods = AnyAuthMethod a : as}

-- | updates the config to use stdout logging
withStdoutLogging :: MindwmConfig -> IO MindwmConfig
...
withStderrLogging :: MindwmConfig -> IO MindwmConfig
...
withNoLogging :: MindwmConfig -> MindwmConfig
...
data MindwmRequest req contentType res accept = MindwmRequest
  { rMethod  :: NH.Method   -- ^ Method of MindwmRequest
  , rUrlPath :: [BCL.ByteString] -- ^ Endpoint of MindwmRequest
  , rParams   :: Params -- ^ params of MindwmRequest
  , rAuthTypes :: [P.TypeRep] -- ^ types of auth methods
  }
  deriving (P.Show)

-- | 'rMethod' Lens
rMethodL :: Lens_' (MindwmRequest req contentType res accept) NH.Method
rMethodL f MindwmRequest{..} = (\rMethod -> MindwmRequest { rMethod, ..} ) <$> f rMethod
{-# INLINE rMethodL #-}

-- | 'rUrlPath' Lens
rUrlPathL :: Lens_' (MindwmRequest req contentType res accept) [BCL.ByteString]
rUrlPathL f MindwmRequest{..} = (\rUrlPath -> MindwmRequest { rUrlPath, ..} ) <$> f rUrlPath
{-# INLINE rUrlPathL #-}

-- | 'rParams' Lens
rParamsL :: Lens_' (MindwmRequest req contentType res accept) Params
rParamsL f MindwmRequest{..} = (\rParams -> MindwmRequest { rParams, ..} ) <$> f rParams
{-# INLINE rParamsL #-}

-- | 'rParams' Lens
rAuthTypesL :: Lens_' (MindwmRequest req contentType res accept) [P.TypeRep]
rAuthTypesL f MindwmRequest{..} = (\rAuthTypes -> MindwmRequest { rAuthTypes, ..} ) <$> f rAuthTypes
{-# INLINE rAuthTypesL #-}
...
class HasBodyParam req param where
  setBodyParam :: forall contentType res accept. (Consumes req contentType, MimeRender contentType param) => MindwmRequest req contentType res accept -> param -> MindwmRequest req contentType res accept
  setBodyParam req xs =
...
class HasOptionalParam req param where
  ...
  applyOptionalParam :: MindwmRequest req contentType res accept -> param -> MindwmRequest req contentType res accept
  applyOptionalParam = (-&-)
  {-# INLINE applyOptionalParam #-}

  -- | infix operator \/ alias for 'addOptionalParam'
  (-&-) :: MindwmRequest req contentType res accept -> param -> MindwmRequest req contentType res accept
  (-&-) = applyOptionalParam
  {-# INLINE (-&-) #-}
...
_mkRequest :: NH.Method -- ^ Method
          ...
          -> MindwmRequest req contentType res accept -- ^ req: Request Type, res: Response Type
_mkRequest m u = MindwmRequest m u _mkParams []

_mkParams :: Params
_mkParams = Params [] [] ParamBodyNone

setHeader ::
     MindwmRequest req contentType res accept
  -> [NH.Header]
  -> MindwmRequest req contentType res accept
...
removeHeader :: MindwmRequest req contentType res accept -> [NH.HeaderName] -> MindwmRequest req contentType res accept
...
_setContentTypeHeader :: forall req contentType res accept. MimeType contentType => MindwmRequest req contentType res accept -> MindwmRequest req contentType res accept
_setContentTypeHeader req =
    case mimeType (P.Proxy :: P.Proxy contentType) of
        Just m -> req `setHeader` [("content-type", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["content-type"]

_setAcceptHeader :: forall req contentType res accept. MimeType accept => MindwmRequest req contentType res accept -> MindwmRequest req contentType res accept
...
addForm :: MindwmRequest req contentType res accept -> WH.Form -> MindwmRequest req contentType res accept
addForm req newform =
...
_addMultiFormPart :: MindwmRequest req contentType res accept -> NH.Part -> MindwmRequest req contentType res accept
...
_setBodyBS :: MindwmRequest req contentType res accept -> B.ByteString -> MindwmRequest req contentType res accept
_setBodyBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyB body)

_setBodyLBS :: MindwmRequest req contentType res accept -> BL.ByteString -> MindwmRequest req contentType res accept
_setBodyLBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyBL body)

_hasAuthType :: AuthMethod authMethod => MindwmRequest req contentType res accept -> P.Proxy authMethod -> MindwmRequest req contentType res accept
...
class P.Typeable a =>
  ...
  applyAuthMethod
    ...
    -> a
    -> MindwmRequest req contentType res accept
    -> IO (MindwmRequest req contentType res accept)
...
_applyAuthMethods
  ...
  -> MindwmConfig
  -> IO (MindwmRequest req contentType res accept)
_applyAuthMethods req config@(MindwmConfig {configAuthMethods = as}) =
  foldlM go req as
  where
