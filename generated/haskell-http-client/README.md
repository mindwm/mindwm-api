## OpenAPI Auto-Generated [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) Bindings to `Mindwm API`

The library in `lib` provides auto-generated-from-OpenAPI [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) bindings to the Mindwm API API.
...
| baseModule                      | Set the base module namespace                                                                                                 |          | Mindwm                      |
| cabalPackage                    | Set the cabal package name, which consists of one or more alphanumeric words separated by hyphens                             |          | mindwm                    |
...
| configType                      | Set the name of the type used for configuration                                                                               |          | MindwmConfig                      |
...
| requestType                     | Set the name of the type used to generate requests                                                                            |          | MindwmRequest                     |
...
| MODULE              | NOTES                                               |
| ------------------- | --------------------------------------------------- |
| Mindwm.Client    | use the "dispatch" functions to send requests       |
| Mindwm.Core      | core functions, config and request types            |
| Mindwm.API       | construct api requests                              |
| Mindwm.Model     | describes api models                                |
| Mindwm.MimeTypes | encoding/decoding MIME types (content-types/accept) |
| Mindwm.ModelLens | lenses for model fields                             |
| Mindwm.Logging   | logging functions and utils                         |
