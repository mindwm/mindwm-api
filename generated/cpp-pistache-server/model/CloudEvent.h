...
public:
    ...
    bool operator==(const CloudEvent& rhs) const;
    bool operator!=(const CloudEvent& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const CloudEvent& o);
    friend  void from_json(const nlohmann::json& j, CloudEvent& o);
protected:
    std::string m_Id;
